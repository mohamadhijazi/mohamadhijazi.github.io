...
// Mock AI Output
const mockBpmnXml2 = `<?xml version="1.0" encoding="UTF-8"?>
...
const mockBpmnXml = `<bpmn:definitions xmlns:bpmn="http://www.omg.org/spec/BPMN/20100524/MODEL" xmlns:bpmndi="http://www.omg.org/spec/BPMN/20100524/DI" xmlns:dc="http://www.omg.org/spec/DD/20100524/DC" xmlns:di="http://www.omg.org/spec/DD/20100524/DI" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" id="Definitions_ExpenseApproval" targetNamespace="http://bpmn.io">  <bpmn:collaboration id="Collaboration_ExpenseApproval">    <bpmn:participant id="Participant_ExpensePool" name="Expense Approval Pool" processRef="Process_ExpenseApproval" />  </bpmn:collaboration>  <bpmn:process id="Process_ExpenseApproval" isExecutable="false">    <bpmn:laneSet id="LaneSet_ExpenseApproval">      <bpmn:lane id="Lane_Accounting" name="Accounting">        <bpmn:flowNodeRef>StartEvent_Accounting</bpmn:flowNodeRef>        <bpmn:flowNodeRef>Task_PrepareExpenseReport</bpmn:flowNodeRef>      </bpmn:lane>      <bpmn:lane id="Lane_Management" name="Management">        <bpmn:flowNodeRef>Task_ApproveBudget</bpmn:flowNodeRef>        <bpmn:flowNodeRef>EndEvent_Management</bpmn:flowNodeRef>      </bpmn:lane>    </bpmn:laneSet>    <bpmn:startEvent id="StartEvent_Accounting">      <bpmn:outgoing>Flow_Start_Prepare</bpmn:outgoing>    </bpmn:startEvent>    <bpmn:task id="Task_PrepareExpenseReport" name="Prepare Expense Report">      <bpmn:incoming>Flow_Start_Prepare</bpmn:incoming>      <bpmn:outgoing>Flow_Cond_Amount</bpmn:outgoing>    </bpmn:task>    <bpmn:task id="Task_ApproveBudget" name="Approve Budget">      <bpmn:incoming>Flow_Cond_Amount</bpmn:incoming>      <bpmn:outgoing>Flow_Approval_End</bpmn:outgoing>    </bpmn:task>    <bpmn:endEvent id="EndEvent_Management">      <bpmn:incoming>Flow_Approval_End</bpmn:incoming>    </bpmn:endEvent>    <bpmn:sequenceFlow id="Flow_Start_Prepare" sourceRef="StartEvent_Accounting" targetRef="Task_PrepareExpenseReport" />    <bpmn:sequenceFlow id="Flow_Cond_Amount" name="Amount > $1000" sourceRef="Task_PrepareExpenseReport" targetRef="Task_ApproveBudget">      <bpmn:conditionExpression xsi:type="bpmn:tFormalExpression">amount &gt; 1000</bpmn:conditionExpression>    </bpmn:sequenceFlow>    <bpmn:sequenceFlow id="Flow_Approval_End" sourceRef="Task_ApproveBudget" targetRef="EndEvent_Management" />  </bpmn:process>  <bpmndi:BPMNDiagram id="BPMNDiagram_ExpenseApproval">    <bpmndi:BPMNPlane id="BPMNPlane_ExpenseApproval" bpmnElement="Collaboration_ExpenseApproval">      <bpmndi:BPMNShape id="Participant_ExpensePool_di" bpmnElement="Participant_ExpensePool" isHorizontal="true">        <dc:Bounds x="100" y="50" width="600" height="400" />      </bpmndi:BPMNShape>      <bpmndi:BPMNShape id="Lane_Accounting_di" bpmnElement="Lane_Accounting" isHorizontal="true">        <dc:Bounds x="130" y="50" width="570" height="200" />      </bpmndi:BPMNShape>      <bpmndi:BPMNShape id="Lane_Management_di" bpmnElement="Lane_Management" isHorizontal="true">        <dc:Bounds x="130" y="250" width="570" height="200" />      </bpmndi:BPMNShape>      <bpmndi:BPMNShape id="StartEvent_Accounting_di" bpmnElement="StartEvent_Accounting">        <dc:Bounds x="160" y="132" width="36" height="36" />      </bpmndi:BPMNShape>      <bpmndi:BPMNShape id="Task_PrepareExpenseReport_di" bpmnElement="Task_PrepareExpenseReport">        <dc:Bounds x="240" y="110" width="100" height="80" />      </bpmndi:BPMNShape>      <bpmndi:BPMNShape id="Task_ApproveBudget_di" bpmnElement="Task_ApproveBudget">        <dc:Bounds x="390" y="310" width="100" height="80" />      </bpmndi:BPMNShape>      <bpmndi:BPMNShape id="EndEvent_Management_di" bpmnElement="EndEvent_Management">        <dc:Bounds x="540" y="332" width="36" height="36" />      </bpmndi:BPMNShape>      <bpmndi:BPMNEdge id="Flow_Start_Prepare_di" bpmnElement="Flow_Start_Prepare">        <di:waypoint x="196" y="150" />        <di:waypoint x="240" y="150" />      </bpmndi:BPMNEdge>      <bpmndi:BPMNEdge id="Flow_Cond_Amount_di" bpmnElement="Flow_Cond_Amount">        <di:waypoint x="340" y="150" />        <di:waypoint x="440" y="150" />        <di:waypoint x="440" y="310" />        <bpmndi:BPMNLabel>          <dc:Bounds x="375" y="130" width="80" height="14" />        </bpmndi:BPMNLabel>      </bpmndi:BPMNEdge>      <bpmndi:BPMNEdge id="Flow_Approval_End_di" bpmnElement="Flow_Approval_End">        <di:waypoint x="490" y="350" />        <di:waypoint x="540" y="350" />      </bpmndi:BPMNEdge>    </bpmndi:BPMNPlane>  </bpmndi:BPMNDiagram></bpmn:definitions>`;
