...
function(t, e) {
    ...
    (r = g || (g = {})).SVG_NS = "http://www.w3.org/2000/svg",
    r.product = "Highcharts",
    r.version = "13.0.0",
    r.win = "u" > typeof window ? window : {},
    r.doc = r.win.document,
    r.svg = !!r.doc?.createElementNS?.(r.SVG_NS, "svg")?.createSVGRect,
    r.pageLang = r.doc?.documentElement?.closest("[lang]")?.lang,
    r.userAgent = r.win.navigator?.userAgent || "",
    ...
    r.supportsPassiveEvents = function() {
        ...
        if (!r.isMS) {
            ...
            r.win.addEventListener && r.win.removeEventListener && (r.win.addEventListener("testPassive", r.noop, e),
    ...
    function q(t, e, i, s) {
        if (i = i || {},
        D?.createEvent && (t.dispatchEvent || t.fireEvent && t !== E)) {
    ...
    function te(t, e) {
        ...
        for (; i.length && j(e); ) {
            ...
            if ("this" === t) {
                let t;
                return tc(e) && (t = e["@this"]),
                t ?? e
            }
            let s = e[t.replace(/[\\'"]/g, "")];
            if (!j(s) || "function" == typeof s || "number" == typeof s.nodeType || s === B)
                return;
            e = s
        }
        return e
    ...
    function ti(t, e, i) {
        ...
        if ("width" === e) {
            ...
            return i < e && i >= e - 1 && (e = Math.floor(i)),
            Math.max(0, e - (ti(t, "padding-left", !0) || 0) - (ti(t, "padding-right", !0) || 0))
        }
        if ("height" === e)
            return Math.max(0, Math.min(t.offsetHeight, t.scrollHeight) - (ti(t, "padding-top", !0) || 0) - (ti(t, "padding-bottom", !0) || 0));
        let o = B.getComputedStyle(t, void 0);
        return o && (s = o.getPropertyValue(e),
        tx(i, "opacity" !== e) && (s = ty(s))),
        s
    }
 ...
 - ${i}: ${e}`,
    ...
    function tO(t, e) {
        ...
        for (i = t.options.isInternal ? o : 0; i < o + 1; i++)
            if (!e[i] || tn(s) && s < tx(e[i].options.index, e[i]._i) || e[i].options.isInternal) {
                e.splice(i, 0, t);
                break
            }
        return i
    ...
    ;
    let tI = (i = Math.random().toString(36).substring(2, 9) + "-",
    s = 0,
    function() {
    ...
    tP.jQuery && (tP.jQuery.fn.highcharts = function() {
        ...
        if (this[0])
            return t[0] ? (new E[th(t[0]) ? t.shift() : "Chart"](this[0],t[0],t[1]),
            this) : tA[W(this[0], "data-highcharts-chart")]
    }
    );
    let {pageLang: tD, win: tB} = E
      , tN = E.isSafari && tB.Intl && !tB.Intl.DateTimeFormat.prototype.formatRange
      , tz = class {
        constructor(t, e) {
            this.options = {
                timezone: "UTC"
        ...
        update(t={}) {
            this.dTLCache = {},
            this.options = t = tp(!0, this.options, t);
        ...
        toParts(t) {
            ...
            return [+o, s - 1, +i, +r, +a, +n, Math.floor(Number(t) || 0) % 1e3, "DLMXJVS".indexOf(e)]
        }
        dateTimeFormat(t, e, i=this.options.locale || tD) {
            ...
            if (!o) {
                ...
                try {
                    ...
                    /Invalid time zone/i.test(e.message) ? (tL(34),
                    t.timeZone = "UTC",
                    o = new Intl.DateTimeFormat(i,t)) : tL(e.message, !1)
                }
            }
        ...
        resolveDTLFormat(t) {
            return tc(t, !0) ? tc(t, !0) && void 0 === t.main ? {
                main: t
            } : t : {
                main: (t = tM(t))[0],
                from: t[1],
      ...
      , tR = class extends tz {
        getBoundaryTicks(t, e, i, s) {
            ...
            let r = j(i) && j(s)
              ...
              , n = e < tE.day
              , h = e < tE.month
              , l = e >= tE.hour ? 9e5 : e >= tE.minute ? 6e4 : e >= tE.second && 1e3;
            if (t.length < 1e4) {
                let d = !0;
        ...
        getTimeTicks(t, e, i, s) {
            ...
            if (s ?? (s = 1),
            j(e)) {
                if (u = a >= tE.second ? 0 : r * Math.floor(u / r),
                a >= tE.second && (g = a >= tE.minute ? 0 : r * Math.floor(g / r)),
                a >= tE.minute && (p = a >= tE.hour ? 0 : r * Math.floor(p / r)),
                a >= tE.hour && (c = a >= tE.day ? 0 : r * Math.floor(c / r)),
                a >= tE.day && (d = a >= tE.month ? 1 : Math.max(1, r * Math.floor(d / r))),
                a >= tE.month && (l = a >= tE.year ? 0 : r * Math.floor(l / r)),
                a >= tE.year && (h -= h % r),
                a === tE.week) {
                ...
                this.variableTimezone && j(i) && (f = i - e > 4 * tE.month || this.getTimezoneOffset(e) !== this.getTimezoneOffset(i));
                let t = e
                  , n = 1;
                for (; t < i; )
                    o.push(t),
                    a === tE.year ? t = this.makeTime(h + n * r, 0) : a === tE.month ? t = this.makeTime(h, l + n * r) : f && (a === tE.day || a === tE.week) ? t = this.makeTime(h, l, d + n * r * (a === tE.day ? 1 : 7)) : f && a === tE.hour && r > 1 ? t = this.makeTime(h, l, d, c + n * r) : t += a * r,
                    n++;
                o.push(t)
            }
            return o.info = _(t, {
      ...
      , tX = {
        ...
        setOptions: function(t) {
            return q(E, "setOptions", {
                options: t
            }),
            tp(!0, tH, t),
            t.time && tG.update(tH.time),
            t.lang && "locale"in t.lang && tG.update({
      ...
      , {win: tF} = E
      , tY = (t, e, i) => 0 === i ? t : 1 === i ? e : `color-mix(in srgb,${t},${e} ${100 * i}%)`
      , tj = t => th(t) && !!t && "none" !== t;
    class t$ {
        static parse(t) {
        ...
        constructor(t) {
            ...
            if ("object" == typeof t && void 0 !== t.stops)
                this.stops = t.stops.map(t => new t$(t[1]));
            else if ("string" == typeof t)
                for (this.input = t = t$.names[t.toLowerCase()] || t,
                s = t$.parsers.length; s-- && !i; )
                    (e = (o = t$.parsers[s]).regex.exec(t)) && (i = o.parse(e));
            i && (this.rgba = i)
        }
        get(t) {
            let e = this.input
        ...
        brighten(t) {
            ...
            if (this.stops)
                ...
                if (tn(e[0]))
                    ...
                    t$.useColorMix && tj(this.input) && (this.output = tY(this.input, t > 0 ? "white" : "black", Math.abs(t)));
            return this
        }
        setOpacity(t) {
            return tn(this.rgba[0]) ? this.rgba[3] = t : t$.useColorMix && tj(this.input) && (this.output = tY(this.input, "#0000", 1 - t)),
            this
        }
        tweenTo(t, e) {
            let i = this.rgba
              , s = t.rgba;
            if (!tn(i[0]) || !tn(s[0]))
                return t$.useColorMix && tj(this.input) && tj(t.input) && e < .99 ? tY(this.input, t.input, e) : t.input || "none";
            let o = 1 !== s[3] || 1 !== i[3]
              , r = (t, s) => t + (i[s] - t) * (1 - e)
    ...
    t$.parsers = [{
        ...
        parse: function(t) {
            return [ty(t[1] + t[1], 16), ty(t[2] + t[2], 16), ty(t[3] + t[3], 16), j(t[4]) ? ty(t[4] + t[4], 16) / 255 : 1]
        }
    }, {
        regex: /^#([a-f0-9]{2})([a-f0-9]{2})([a-f0-9]{2})([a-f0-9]{2})?$/i,
        parse: function(t) {
            return [ty(t[1], 16), ty(t[2], 16), ty(t[3], 16), j(t[4]) ? ty(t[4], 16) / 255 : 1]
        }
    }],
    t$.useColorMix = tF.CSS?.supports("color", "color-mix(in srgb,red,blue 9%)"),
    t$.None = new t$("");
    let {parse: tV} = t$
      , {win: tU} = E;
    class tZ {
        ...
        run(t, e, i) {
            let s = this
              ...
              , n = function() {
                for (let t = 0; t < tZ.timers.length; t++)
                    tZ.timers[t]() || tZ.timers.splice(t--, 1);
            ...
            r.elem = this.elem,
            r.prop = this.prop,
            r() && 1 === tZ.timers.push(r) && a(n)) : (delete o.curAnim[this.prop],
        ...
        initPath(t, e, i) {
            ...
            return g.length && tn(l) && (d = r.length + l * n,
            p ? (u(g, r),
            f(r)) : (u(r, g),
            f(g))),
            [g, r]
    ...
    function tK(t, e) {
        ...
        for (; i--; )
            tZ.timers[i].elem !== t || e && e !== tZ.timers[i].prop || (tZ.timers[i].stopped = !0)
    }
    tZ.timers = [];
    let tq = {
        animate: function(t, e, i) {
            ...
            tu(e, function(n, h) {
                ...
                a = new tZ(t,i,h),
                r = void 0,
                "d" === h && tl(e.d) ? (a.paths = a.initPath(t, t.pathArray, e.d),
                a.toD = e.d,
                s = 0,
                r = 1) : t.attr ? s = t.attr(h) : (s = parseFloat(ti(t, h)) || 0,
                "opacity" !== h && (o = "px")),
                r || (r = n),
        ...
        getDeferredAnimation: function(t, e, i) {
            ...
            return o.forEach(t => {
                ...
                r = tc(e) && j(e.defer) ? s.defer : Math.max(r, i.duration + i.defer),
      ...
      , {SVG_NS: tJ, win: tQ} = E
      , {trustedTypes: t0} = tQ
      , t1 = t0 && td(t0.createPolicy) && t0.createPolicy("highcharts", {
        createHTML: t => t
    })
      , t2 = t1 ? t1.createHTML("") : "";
    class t5 {
        static filterUserAttributes(t) {
            return tu(t, (e, i) => {
                let s = !0;
                -1 === t5.allowedAttributes.indexOf(i) && (s = !1),
                -1 !== ["background", "dynsrc", "href", "lowsrc", "src"].indexOf(i) && (s = th(e) && t5.allowedReferences.some(t => 0 === e.indexOf(t))),
                s || (tL(33, !1, void 0, {
                    "Invalid attribute in config": `${i}`
                }),
                delete t[i]),
                th(e) && t[i] && (t[i] = e.replace(/</g, "&lt;"))
            }
            ),
            t
        }
        ...
        static setElementHTML(t, e) {
            t.innerHTML = t5.emptyHTML,
            e && new t5(e).addToDOM(t)
        }
        constructor(t) {
                ...
                return tM(e).forEach(function(e) {
                    ...
                    if (r)
                        if ("#text" === r)
                            ...
                            let s = "svg" === r ? tJ : i.namespaceURI || tJ
                              , h = E.doc.createElementNS(s, r)
                              , l = e.attributes || {};
                            tu(e, function(t, e) {
                                "tagName" !== e && "attributes" !== e && "children" !== e && "style" !== e && "textContent" !== e && (l[e] = t)
                            }),
                            W(h, n ? l : t5.filterUserAttributes(l)),
                            e.style && Y(h, e.style),
                            a && h.appendChild(a),
                            t(e.children || [], h),
                            o = h
    ...
    let {defaultOptions: t3, defaultTime: t6} = tX
      ...
      , t4 = {
        ...
        each: function(t) {
            ...
            return !!tl(t) && t.map( (i, s) => t7(e.body, _(tc(i) ? i : {
                "@this": i
            }, {
                "@index": s,
                "@first": 0 === s,
        ...
        return r.forEach(s => {
            ...
            if (m) {
                ...
                for (p = t4[m].length; p--; )
                    t.unshift(c(o[p + 1]));
                r = t4[m].apply(e, t),
                s.isBlock && "boolean" == typeof r && (r = t7(r ? g : u, e, i))
            } else {
    ...
    function et(t, e, i, s) {
        ...
        i ?? (i = h.decimalPoint),
        s ?? (s = h.thousandsSep),
        -1 === e ? e = Math.min(l, 20) : tn(e) ? e && n < 0 && ((r = e + n) >= 0 ? (a = +a.toExponential(r).split("e")[0],
        e = r) : (a = Math.floor(a),
        t = e < 20 ? +(a * Math.pow(10, n)).toFixed(e) : 0,
        n = 0)) : e = 2,
        n && (e ?? (e = 2),
        t = a),
        tn(e) && e >= 0 && (c.minimumFractionDigits = e,
        c.maximumFractionDigits = e),
        "" === s && (c.useGrouping = !1);
        let p = s || i
          , g = p ? "en" : this?.locale || h.locale || t9
          , u = JSON.stringify(c) + g;
        return o = (t8[u] ?? (t8[u] = new Intl.NumberFormat(g,c))).format(t),
    ...
    (u || (u = {})).distribute = function t(e, i, s) {
        ...
        e = e.map(t => ({
            ...
            for (c = e.length; c--; )
                g = e[c],
                u = (Math.min.apply(0, g.targets) + Math.max.apply(0, g.targets)) / 2,
                g.pos = H(u - g.size * g.align, 0, i - g.size);
            for (c = e.length,
            p = !1; c--; )
    ...
    ;
    let ei = u
      , {animate: es, animObject: eo, stop: er} = tq
      , {deg2rad: ea, doc: en, svg: eh, SVG_NS: el, win: ed, isFirefox: ec} = E;
    class ep {
        _defaultGetter(t) {
        ...
        align(t, e, i, s=!0) {
            ...
            i = void 0);
            let h = tx(i, o[n], o)
              , l = (h.x || 0) + (t.x || 0) + ((h.width || 0) - (t.width || 0)) * J(t.align)
              , d = (h.y || 0) + (t.y || 0) + ((h.height || 0) - (t.height || 0)) * J(t.verticalAlign)
              , c = {};
        ...
        animate(t, e, i) {
            let s = eo(tx(e, this.renderer.globalAnimation, !0))
              , o = s.defer;
            return en.hidden && (s.duration = 0),
        ...
        attr(t, e, i, s) {
            ...
            (t = {})[a] = e),
            "string" == typeof t ? h = (this[t + "Getter"] || this._defaultGetter).call(this, t, o) : (tu(t, function(e, i) {
                l = !1,
                s || er(this, i),
        ...
        crisp(t, e) {
            ...
            j(t.strokeWidth) && (t.strokeWidth = e),
            t
        }
        complexColor(t, e, i) {
            ...
            q(this.renderer, "complexColor", {
                ...
                r) {
                    ...
                    "radialGradient" === r && c && !j(a.gradientUnits) && (n = a,
                    a = tp(a, s.getRadialAttr(c, n), {
                        gradientUnits: "userSpaceOnUse"
                    })),
                    tu(a, function(t, e) {
                        "id" !== e && g.push(e, t)
                    ...
                    h[g = g.join(",")])
                        ...
                        t.stops = [],
                        l.forEach( ([e,i]) => {
                            0 === i.indexOf("rgba") ? (i = (o = t$.parse(i)).get("rgb"),
                            d = o.get("a")) : d = 1;
        ...
        css(t) {
            ...
            a) {
                e && (t = _(e, i)),
                null === t.width || "auto" === t.width ? delete this.textWidth : "text" === s.nodeName.toLowerCase() && t.width && (r = this.textWidth = ty(t.width)),
                _(this.styles, t),
                r && !eh && o.forExport && delete t.width;
                let a = ec && t.fontSize || null;
                a && (tn(a) || /^\d+$/.test(a)) && (t.fontSize += "px");
                let n = tp(t);
                s.namespaceURI === this.SVG_NS && (["textOutline", "textOverflow", "whiteSpace", "width"].forEach(t => n && delete n[t]),
                n.color && (n.fill = n.color,
                delete n.color)),
                Y(s, n)
            }
            return this.added && ("text" === this.element.nodeName && o.buildText(this),
        ...
        destroy() {
            ...
            t.safeRemoveChild(e),
            t.alignOptions && Z(i.alignedObjects, t),
            tu(t, (e, i) => {
        ...
        dSetter(t, e, i) {
            tl(t) && ("string" == typeof t[0] && (t = this.renderer.pathToSegments(t)),
            this.pathArray = t,
        ...
        getBBox(t, e) {
            let i, s, o, {element: r, renderer: a, styles: n, textStr: h} = this, {cache: l, cacheKeys: d} = a, c = r.namespaceURI === this.SVG_NS, p = tx(e, this.rotation, 0), g = a.styledMode ? r && ep.prototype.getStyle.call(r, "font-size") : n.fontSize, u = this.getBBoxCacheKey([a.rootFontSize, this.textWidth, this.alignValue, n.fontWeight, n.lineClamp, n.textOverflow, g, p]);
            if (u && !t && (i = l[u]),
            !i || i.polygon) {
                if (c || a.forExport) {
                    try {
        ...
        constructor(t, e) {
            ...
            this.opacity = 1,
            this.SVG_NS = el,
            this.element = "div" === e || "body" === e ? X(e) : en.createElementNS(this.SVG_NS, e),
            this.renderer = t,
            this.styles = {},
            q(this, "afterInit")
        }
        ...
        shadow(t) {
            let {renderer: e} = this
              , i = tp(this.parentGroup?.rotation === 90 ? {
                offsetX: -1,
                offsetY: -1
            } : {}, tc(t) ? t : {})
        ...
        titleSetter(t) {
            ...
            i.textContent = tk(tx(t, ""), [/<[^>]*>/g, ""]).replace(/&lt;/g, "<").replace(/&gt;/g, ">")
        }
        toFront() {
            let t = this.element;
        ...
        updateTransform(t="transform") {
            let {element: e, foreignObject: i, matrix: s, rotation: o=0, rotationOriginX: r, rotationOriginY: a, scaleX: n, scaleY: h, text: l, translateX: d=0, translateY: c=0} = this
              , p = [`translate(${d},${c})`];
            j(s) && p.push("matrix(" + s.join(",") + ")"),
            o && p.push("rotate(" + o + " " + (r ?? e.getAttribute("x") ?? this.x ?? 0) + " " + (a ?? e.getAttribute("y") ?? this.y ?? 0) + ")"),
            (j(n) || j(h)) && p.push(`scale(${n ?? 1} ${h ?? 1})`),
        ...
        zIndexSetter(t, e) {
            ...
            if (j(t) ? (i.setAttribute("data-z-index", t),
            t *= 1,
            this[e] === t && (p = !1)) : j(this[e]) && i.removeAttribute("data-z-index"),
            this[e] = t,
            p) {
                for ((t = this.zIndex) && s && (s.handleZ = !0),
                g = (n = r.childNodes).length - 1; g >= 0 && !d; g--)
                    c = !j(l = (h = n[g]).getAttribute("data-z-index")),
                    h !== i && (j(t) && t < 0 && c && !a && !g ? (r.insertBefore(i, n[g]),
                    d = !0) : (j(t) && parseFloat(l || "") <= t || c && (!j(t) || t >= 0)) && (r.insertBefore(i, n[g + 1]),
                    d = !0));
                d || (r.insertBefore(i, n[3 * !!a]),
                d = !0)
            }
            return d
        }
    }
    ep.symbolCustomAttribs = ["anchorX", "anchorY", "clockwise", "end", "height", "innerR", "r", "start", "width", "x", "y"],
    ep.prototype.strokeSetter = ep.prototype.fillSetter,
    ep.prototype.yGetter = ep.prototype.xGetter,
    ep.prototype.matrixSetter = ep.prototype.rotationOriginXSetter = ep.prototype.rotationOriginYSetter = ep.prototype.rotationSetter = ep.prototype.scaleXSetter = ep.prototype.scaleYSetter = ep.prototype.translateXSetter = ep.prototype.translateYSetter = ep.prototype.verticalAlignSetter = function(t, e) {
        this[e] = t,
        this.doTransform = !0
    }
    ;
    let eg = ep
      , {charts: eu} = E
      , ef = ["#2caffe", "#544fc5", "#00e272", "#fe6a35", "#6b8abc", "#d568fb", "#2ee0ca", "#fa4b42", "#feb56a", "#91e8e1"]
      , em = [null, "#00e272", "#efdf00"];
    class ex {
        constructor(t, e) {
        ...
        injectCSS(t) {
            let e, i, s, {cssVars: o, renderer: r} = this, a = Object.keys(U(t, this.defaultOptions)).length > 0, n = Math.max(t.colors?.length || 0, ef.length), h = "light", l = (t, e) => {
                th(t) && (e = e.replace(/([0-9]+)/g, "-$1").replace(/[A-Z]/g, t => `-${t.toLowerCase()}`),
                o[h][`--highcharts-${e}`] = t)
            }
            ;
            for (let e of ["light", "dark"]) {
                let i = t[e] || {}
                  , s = {}
                  , r = new t$(i?.neutralColor || "")
                  , a = new t$(i?.backgroundColor || "")
                  , d = new t$(i?.highlightColor || "");
                h = e,
                ...
                for (let s = 0; s < n; s++)
                    l(i?.colors?.[s] || t.colors?.[s] || ("dark" === e ? em : [])?.[s] || ef[s] || "#888a", `color${s}`);
                tu(i, l),
                tu(s, l),
                "light" === e && _(o.dark, o.light)
            }
            let d = r.defs.element
              , c = a ? `*[data-highcharts-chart="${r.chartIndex}"]` : ""
              , p = d.querySelector("style.highcharts-palette") || r.box.ownerDocument.createElement("style");
            p.parentNode || (p.nonce = "highcharts",
  ...
  color-scheme: dark;
        ...
        update(t) {
            let e = this.renderer.box.parentElement
              , i = eu?.[this.renderer.chartIndex];
            t = tp(!0, this.options, t),
            i && (i.options.palette = t),
            !1 !== t.injectCSS && this.injectCSS(t),
            e && (th(t.colorScheme) && ["light", "dark", "inherit"].includes(t.colorScheme) ? e.style.colorScheme = t.colorScheme : e.style.removeProperty("color-scheme"))
        }
    }
    class ey extends eg {
        ...
        alignSetter(t) {
            ...
            this.bBox && tn(this.xSetting) && this.attr({
                x: this.xSetting
            }),
        ...
        destroy() {
            tw(this.element, "mouseenter"),
            tw(this.element, "mouseleave"),
            this.text && this.text.destroy(),
            this.box && (this.box = this.box.destroy()),
            eg.prototype.destroy.call(this)
        }
        fillSetter(t, e) {
            t && (this.needsBox = !0),
            this.fill = t,
        ...
        updateBoxSize() {
            ...
            this.needsBox && !e.textPath) {
                ...
                this.box.attr(_(i, this.deferredAttr)),
                this.deferredAttr = {}
            }
        }
        updateTextPadding() {
            ...
            if (!t.textPath) {
                ...
                let i = this.baseline ? 0 : this.baselineOffset
                  , s = (this.paddingLeft ?? this.padding) + J(e) * (this.widthSetting ?? this.bBox.width);
                (s !== t.x || i !== t.y) && (t.attr({
                    align: e,
                    x: s
                }),
        ...
        widthSetter(t) {
            this.widthSetting = tn(t) ? t : void 0,
            this.doUpdate = !0
        }
        getPaddedWidth() {
            let t = this.padding
              , e = tx(this.paddingLeft, t)
              , i = tx(this.paddingRight, t);
    ...
    function eb(t, e, i, s, o) {
        ...
        if (o) {
            ...
            let c = o.innerR
              ...
              , f = d ? 0 : Math.cos(n)
              , m = d ? 1 : Math.sin(n)
              , x = tx(o.longArc, n - a - Math.PI < 1e-4 ? 0 : 1)
              , y = ["A", h, l, 0, x, tx(o.clockwise, 1), t + (d ? .001 : h * f), e + l * m];
            y.params = {
                start: a,
                end: n,
                cx: t,
            ...
            j(c) && ((y = ["A", c, c, 0, x, j(o.clockwise) ? 1 - o.clockwise : 0, t + (d ? -.001 : c * g), e + c * u]).params = {
                start: n,
                end: a,
                cx: t,
                cy: e
            },
            r.push(p ? ["M", t + c * f, e + c * m] : ["L", t + c * f, e + c * m], y)),
            p || r.push(["Z"])
        }
        return r
    }
    function ev(t, e, i, s, o) {
        return o?.r ? ek(t, e, i, s, o) : [["M", t, e], ["L", t + i, e], ["L", t + i, e + s], ["L", t, e + s], ["Z"]]
    }
    ...
    ey.textProps = ["color", "direction", "fontFamily", "fontSize", "fontStyle", "fontWeight", "lineClamp", "lineHeight", "textAlign", "textDecoration", "textOutline", "textOverflow", "whiteSpace", "width"];
    let ew = {
        arc: eb,
      ...
      , eA = class {
        ...
        buildSVG() {
            ...
            if (n !== t.textCache) {
                ...
                if (o || this.ellipsis || this.width || t.textPath || -1 !== s.indexOf(" ") && (!this.noWrap || /<br.*?>/g.test(s))) {
                    ...
                    e.appendChild(eM.createTextNode(this.unescapeEntities(s)));
                ...
                if (n) {
                    ...
                    for (; a.length; )
                        ...
                        this.lineClamp && d >= this.lineClamp) {
                            a.length && (this.truncate(t, t.textContent || "", void 0, 0, s, l, eT),
                    ...
                    this.ellipsis && r && this.truncate(t, r, void 0, 0, s, l, eT)
            }
              , r = t => {
                [].slice.call(t.childNodes).forEach(i => {
                    i.nodeType === eS.Node.TEXT_NODE ? o(i, t) : (-1 !== i.className.baseVal.indexOf("highcharts-br") && (e.actualWidth = 0),
                    r(i))
                }
                )
            }
        ...
        modifyTree(t) {
            ...
            ;
            t.forEach(e),
            q(this.svgElement, "afterModifyTree", {
                nodes: t
            })
        }
        truncate(t, e, i, s, o, r, a) {
            ...
            s + (h = f(t.textContent.length)) > o) {
                ...
                this.ellipsis && h > o && this.truncate(t, t.textContent || "", void 0, 0, o, r, eT)
            }
            i && i.splice(0, u),
            l.actualWidth = h,
            l.rotation = d
      ...
      , {defaultOptions: eP} = tX
      , {charts: eL, deg2rad: eO, doc: eE, isFirefox: eI, isMS: eD, isWebKit: eB, noop: eN, SVG_NS: ez, symbolSizes: eR, win: eW} = E;
    class eH {
        constructor(t, e, i, s, o, r, a, n, h) {
            ...
            t.appendChild(p),
            W(t, "dir", "ltr"),
            -1 === t.innerHTML.indexOf("xmlns") && W(p, "xmlns", this.SVG_NS),
            this.box = p,
            this.boxWrapper = c,
            this.alignedObjects = [],
            this.url = this.getReferenceURL(),
            this.createElement("desc").add().element.appendChild(eE.createTextNode("Created with Highcharts 13.0.0")),
            ...
            this.setSize(e, i, !1),
            a || (c.css(this.getStyle(s || {})),
            this.palette = new ex(this,n || eP.palette)),
            eI && t.getBoundingClientRect && ((l = function() {
                Y(t, {
                    left: 0,
                    top: 0
                }),
        ...
        getReferenceURL() {
            if ((eI || eB) && eE.getElementsByTagName("base").length) {
                if (!j(e)) {
                    ...
                    let s = eE.elementFromPoint(6, 6);
                    e = s?.id === "hitme",
                    eE.body.removeChild(i)
                }
                if (e)
                    return tk(eW.location.href.split("#")[0], [/<[^>]*>/g, ""], [/([\('\)])/g, "\\$1"], [/ /g, "%20"])
            }
            return ""
        }
        getStyle(t) {
        ...
        button(t, e, i, s, o={}, r, a, n, h, l) {
            ...
            delete o.states,
            delete o.style;
            let m = [t5.filterUserAttributes(o)]
              , x = [f];
            return c || ["hover", "select", "disabled"].forEach( (t, e) => {
                m.push(tp(m[0], t5.filterUserAttributes(p[e + 5] || u[t] || {}))),
                x.push(m[e + 1].style),
                delete m[e + 1].style
            }
            ),
        ...
        crispLine(t, e) {
            let[i,s] = t;
            return j(i[1]) && i[1] === s[1] && (i[1] = s[1] = F(i[1], e)),
            j(i[2]) && i[2] === s[2] && (i[2] = s[2] = F(i[2], e)),
            t
        }
        path(t) {
        ...
        symbol(t, e, i, s, o, r) {
            ...
            if (u)
                ...
                s.imgwidth = tx(r?.width, eR[h]?.width),
                s.imgheight = tx(r?.height, eR[h]?.height),
                l = t => t.attr({
                    width: t.width,
                    height: t.height
                }),
                ...
                s.isImg = !0,
                j(s.imgwidth) && j(s.imgheight) ? l(s) : (s.attr({
                    width: 0,
                    height: 0
                }),
                X("img", {
        ...
        fontMetrics(t) {
            let e = tn(t) ? t : ty(eg.prototype.getStyle.call(t, "font-size") || 0)
        ...
        pathToSegments(t) {
            ...
            for (let o = 0; o < t.length; o++)
                th(i[0]) && tn(t[o]) && i.length === s[i[0].toUpperCase()] && t.splice(o, 0, i[0].replace("M", "L").replace("m", "l")),
    ...
    class eF extends eg {
        ...
        css(t) {
            ...
            t.overflow = "hidden") : t?.lineClamp === 0 && (t.display = "inline-block"),
            tn(Number(t?.fontSize)) && (t.fontSize += "px"),
            _(this.styles, t),
            Y(i, t),
        ...
        updateTransform() {
            ...
            let {element: e, foreignObject: i, oldTextWidth: s, renderer: o, rotation: r, scaleX: a, styles: {display: n="inline-block", whiteSpace: h}, textAlign: l="left", textWidth: d, x: c=0, y: p=0} = this
              , g = () => this.textPxLength ? this.textPxLength : (Y(e, {
                width: "",
                whiteSpace: h || "nowrap"
            }),
            e.offsetWidth)
            ...
            u !== this.cTT && (t = o.fontMetrics(e).b,
            this.getSpanCorrection(!j(r) && !this.textWidth && this.textPxLength || e.offsetWidth, t, J(l))),
        ...
        textSetter(t) {
            t !== this.textStr && (delete this.oldTextWidth,
            t5.setElementHTML(this.element, t ?? ""),
            this.textStr = t,
            this.doTransform = !0)
        }
        alignSetter(t) {
    ...
    (m || (m = {})).registerEventOptions = function(t, e) {
        ...
        tu(e.events, function(e, i) {
            t.eventOptions[i] !== e && (t.eventOptions[i] && (tw(t, i, t.eventOptions[i]),
            delete t.eventOptions[i]),
            td(e) && (t.eventOptions[i] = e,
            N(t, i, e, {
                order: 0
            })))
        })
    ...
    let e$ = m
      ...
      , eU = class {
        ...
        addLabel() {
            ...
            e.dateTime && u)
                if (p) {
                    let t = p.unitName
                      ...
                      , o = !i.grid?.enabled && g && e && u[e]?.boundary || u[t];
                    m = (x = s.time.resolveDTLFormat(o)).main
                } else
                    tn(b) && (m = e.dateTime.getXDateFormat(b, u || {}));
            t.isFirst = d,
            t.isLast = c,
            t.boundary = g;
            let v = {
            ...
            let k = t => h.formatter ? h.formatter.call(t, t) : h.format ? (t.text = e.defaultLabelFormatter.call(t),
            ee.format(h.format, t, s)) : e.defaultLabelFormatter.call(t)
              , w = k.call(v, v)
              , M = x?.list;
            M ? t.shortenLabel = function() {
                for (y = 0; y < M.length; y++)
                    if (_(v, {
                        dateTimeLabelFormat: M[y]
                    }),
                    f.attr({
                        text: k.call(v, v)
                    }),
                    f.getBBox().width < e.getSlotWidth(t) - 2 * (h.padding || 0))
                        return;
                f.attr({
                    text: ""
                })
            ...
            f ? f.textStr !== w && (!f.textWidth || h.style.width || f.styles.width || f.css({
                width: void 0
            }),
            f.attr({
                text: w
            }),
            f.textPxLength = f.getBBox().width) : (t.label = f = t.createLabel(w, h),
            t.rotation = 0)
        }
        createLabel(t, e, i) {
            let s = this.axis
              ...
              , n = j(t) && e.enabled ? o.text(t, i?.x, i?.y, e.useHTML).add(s.labelGroup) : void 0;
            return n && (r || n.css(tp(e.style)),
        ...
        getLabelPosition(t, e, i, s, o, r, a, n) {
            ...
            return h = 0 === d.side ? i.rotation ? -m : -i.getBBox().height : 2 === d.side ? u.y + m : Math.cos(i.rotation * eV) * (u.y - i.getBBox(!1, 0).height / 2),
            j(o.y) && (h = 0 === d.side && d.horiz ? o.y + h : o.y),
            t = t + tx(o.x, [0, 1, 0, -1][d.side] * m) + f + u.x - (r && s ? r * c * (p ? -1 : 1) : 0),
        ...
        handleOverflow(t) {
            ...
            l || "justify" !== i.overflow ? l < 0 && s - d * c < a ? f = Math.round(s / Math.cos(l * eV) - a) : l > 0 && s + d * c > n && (f = Math.round((o - s) / Math.cos(l * eV))) : (s - d * c < a ? g = t.x + g * (1 - d) - a : s + (1 - d) * c > n && (g = n - t.x + g * d,
            u = -1),
            (g = Math.min(p, g)) < p && "center" === e.labelAlign && (t.x += u * (p - g - d * (p - Math.min(c, g)))),
            (c > g || e.autoRotation && h?.styles?.width) && (f = g)),
            f && h && (this.shortenLabel ? this.shortenLabel() : h.css(_({}, {
        ...
        render(t, e, i) {
            let s = this.axis
              , o = s.horiz
              , r = this.pos
              , a = tx(this.tickmarkOffset, s.tickmarkOffset)
              ...
              , c = d + s.len
              , p = o ? h : l
              , g = tx(i, this.label?.newOpacity, 1);
            !s.chart.polar && (G(p) < d || p > c) && (i = 0),
            i ?? (i = 1),
            this.isActive = !0,
        ...
        renderMark(t, e) {
            let i = this.axis
              ...
              , n = t.x
              , h = t.y
              , l = tx(s["minor" !== r ? "tickWidth" : "minorTickWidth"], !r && i.isXAxis ? 1 : 0)
        ...
        renderLabel(t, e, i, s) {
            let o = this.axis
              ...
              , h = a.labels
              , l = h.step
              , d = tx(this.tickmarkOffset, o.tickmarkOffset)
              , c = t.x
              , p = t.y
              , g = !0;
            n && tn(c) && (n.xy = t = this.getLabelPosition(c, p, n, r, h, d, s, l),
            (!this.isFirst || this.isLast || a.showFirstLabel) && (!this.isLast || this.isFirst || a.showLastLabel) ? r && !e && 0 !== i && this.handleOverflow(t) : g = !1,
            l && s % l && (g = !1),
            g && tn(t.y) ? (t.opacity = i,
      ...
      , {animObject: eZ} = tq
      , {xAxis: e_, yAxis: eK} = ej
      , {parse: eq} = t$
      , {defaultOptions: eJ} = tX
      , {registerEventOptions: eQ} = e$
      , {deg2rad: e0} = E
      , e1 = (t, e) => tg(e, void 0, void 0, tx(t.options.allowDecimals, e < .5 || void 0 !== t.tickAmount), !!t.tickAmount);
    _(eJ, {
        xAxis: e_,
        yAxis: tp(e_, eK)
    });
    class e2 {
        ...
        init(t, e, i=this.coll) {
            ...
            this.opposite = tx(e.opposite, this.opposite),
            this.side = tx(e.side, this.side, o ? 2 * !this.opposite : this.opposite ? 1 : 3),
            this.setOptions(e);
            let r = this.options
              , a = r.labels;
            ...
            t.inverted && !this.isZAxis && s && !j(this.reversed) && (this.reversed = !0),
            this.labelRotation = tn(a.rotation) ? a.rotation : void 0,
            eQ(this, r),
            q(this, "afterInit")
        }
        setOptions(t) {
            ...
            this.options = tp(e, "yAxis" === this.coll ? {
                title: {
        ...
        defaultLabelFormatter() {
            ...
            if (r)
                ...
                g = o.dateFormat(a, s, !0);
            else if (c && h && d >= 1e3)
                for (; c-- && void 0 === g; )
                    d >= (p = Math.pow(l, c + 1)) && 10 * s % p == 0 && null !== h[c] && 0 !== s && (g = i(s / p, -1, void 0, void 0, e) + h[c]);
            return g ?? (g = i(s, -1, void 0, 1e4 > Math.abs(s) ? "" : void 0, e)),
            g
        }
        getSeriesExtremes() {
            let t, e = this;
                ...
                e.series.forEach(i => {
                    if (i.reserveSpace()) {
                        ...
                        e.isXAxis)
                            ...
                            n = t.max,
                            tn(a) || a instanceof Date || (o = o.filter(tn),
                            a = (t = i.getXExtremes(o)).min,
                            n = t.max),
                            o.length && (e.dataMin = Math.min(tx(e.dataMin, a), a),
                            e.dataMax = Math.max(tx(e.dataMax, n), n)));
                        else {
                            let t = i.applyExtremes();
                            tn(t.dataMin) && (a = t.dataMin,
                            e.dataMin = Math.min(tx(e.dataMin, a), a)),
                            tn(t.dataMax) && (n = t.dataMax,
                            e.dataMax = Math.max(tx(e.dataMax, n), n)),
                            j(r) && (e.threshold = r),
        ...
        getPlotLinePath(t) {
            ...
            function y(t, e, i) {
                return "pass" !== p && (t < e || t > i) && (p ? t = H(t, e, i) : x = !0),
                t
            }
            let b = {
                value: a,
            ...
            return q(this, "getPlotLinePath", b, function(t) {
                g = f = (c = H(c = tx(c, e.translate(a, void 0, void 0, r)), -1e9, 1e9)) + d,
                u = m = h - c - d,
                tn(c) ? e.horiz ? (u = o,
        ...
        adjustForMinRange() {
            ...
            tn(s) && tn(o) && tn(r) && s - o < r && (n = this.dataMax - this.dataMin >= r,
            a = (r - s + o) / 2,
            h = [o - a, i.parse(t.min) ?? o - a],
            n && (h[2] = e ? e.log2lin(this.dataMin) : this.dataMin),
            l = [(o = R(h)) + r, i.parse(t.max) ?? o + r],
        ...
        nameToX(t, e) {
            ...
            return r.requireSorting = !1,
            j(e) || (e = this.uniqueNames && a ? s ? a.indexOf(o) : n[o] ?? -1 : r.autoIncrement()),
            -1 === e ? !s && a && (i = a.length) : tn(e) && (i = e),
            void 0 !== i ? (this.names[i] = t.name,
            n[t.name] = i) : i = tn(t.x) ? t.x : r.autoIncrement(),
            i
        }
        updateNames() {
            let t = this
        ...
        setAxisTranslation() {
            ...
            h = i.pointRangePadding) : t.series.forEach(function(e) {
                let i = s ? 1 : o ? tx(e.options.pointRange, a, 0) : t.axisPointRange || 0
                  , l = e.options.pointPlacement;
                if (r = Math.max(r, i),
                !t.single || s) {
                    let t = e.is("xrange") ? !o : o;
                    n = Math.max(n, t && th(l) ? 0 : i / 2),
        ...
        setTickInterval(t) {
            ...
            A = tx(this.userMin, d.parse(h.min)),
            P = tx(this.userMax, d.parse(h.max)),
            y ? (this.linkedParent = y,
            M = y.getExtremes(),
            this.min = tx(M.min, M.dataMin),
            this.max = tx(M.max, M.dataMax),
            this.type !== y.type && tL(11, !0, i)) : (l && j(c) && tn(s) && tn(o) && (o >= c ? (S = c,
            k = 0) : s <= c && (T = c,
            v = 0)),
            this.min = tx(A, S, o),
            this.max = tx(P, T, s)),
            tn(this.max) && tn(this.min) && (n && (this.positiveValuesOnly && !t && 0 >= Math.min(this.min, tx(o, this.min)) && tL(10, !0, i),
            this.min = G(n.log2lin(this.min), 16),
            this.max = G(n.log2lin(this.max), 16)),
            this.range && tn(o) && (this.userMin = this.min = A = Math.max(o, this.minFromRange() || 0),
            this.userMax = P = this.max,
            this.range = void 0)),
            q(this, "foundExtremes"),
            this.adjustForMinRange(),
            tn(this.min) && tn(this.max)) {
                if (!tn(this.userMin) && tn(x) && x < this.min && (this.min = A = x),
                !tn(this.userMax) && tn(m) && m > this.max && (this.max = P = m),
                e || this.axisPointRange || this.stacking?.usePercentage || y || (w = this.max - this.min) && (!j(A) && k && (this.min -= w * k),
                !j(P) && v && (this.max += w * v)),
                !tn(this.userMin) && tn(u) && (this.min = Math.max(this.min, u)),
                !tn(this.userMax) && tn(g) && (this.max = Math.min(this.max, g)),
                l && tn(o) && tn(s)) {
                    let t = c || 0;
                ...
                !i.polar && this.min > this.max && (j(h.min) ? this.max = this.min : j(h.max) && (this.min = this.max)),
                w = this.max - this.min
            }
            if (this.min !== this.max && tn(this.min) && tn(this.max) ? y && !C && b === y.options.tickPixelInterval ? this.tickInterval = C = y.tickInterval : this.tickInterval = tx(C, this.tickAmount ? w / Math.max(this.tickAmount - 1, 1) : void 0, e ? 1 : w * b / Math.max(this.len, b)) : this.tickInterval = 1,
            a && !t) {
            ...
            this.pointRange && !C && (this.tickInterval = Math.max(this.pointRange, this.tickInterval));
            let L = tx(h.minTickInterval, r && !this.series.some(t => !t.sorted) ? this.closestPointRange : 0);
            !C && L && this.tickInterval < L && (this.tickInterval = L),
            r || n || C || (this.tickInterval = e1(this, this.tickInterval)),
        ...
        setTickPositions() {
            ...
            this.single = this.min === this.max && j(this.min) && !this.tickAmount && (this.min % 1 == 0 || !1 !== t.allowDecimals),
            e)
                n = e.slice();
                ...
                if (!this.ordinal?.positions && (this.max - this.min) / this.tickInterval > Math.max(2 * this.len, 200))
                    ...
                    for (; e <= 2 * t; )
                        ...
                        this.tickAmount && n.length > this.tickAmount)
                            this.tickInterval = e1(this, e *= 1.1);
                        else
                            break
                }
            ...
            !this.isLinked && tn(this.min) && tn(this.max) && (this.single && n.length < 2 && !this.categories && !this.series.some(t => t.is("heatmap") && "between" === t.options.pointPlacement) && (this.min -= .5,
            this.max += .5),
        ...
        getThresholdAlignment(t) {
            if ((!tn(this.dataMin) || this !== t && this.series.some(t => t.isDirty || t.isDirtyData || t.xAxis?.isDirty)) && this.getSeriesExtremes(),
            tn(this.threshold)) {
        ...
        getTickAmount() {
            let t = this.options
              ...
              , i = t.tickAmount;
            j(t.tickInterval) || i || !(this.len < e) || this.isRadial || this.logarithmic || !t.startOnTick || !t.endOnTick || (i = 2),
        ...
        adjustTickAmount() {
            ...
            if (tn(n) && (g = 0 === n ? 0 : 1 === n ? a - 1 : Math.round(H(n * (a - 1), 1, a - 2)),
            o.reversed && (g = a - 1 - g)),
            t.hasData() && tn(s) && tn(i)) {
                let n = () => {
                    t.transA *= (h - 1) / (a - 1),
        ...
        setAxisSize() {
            let t = this.chart
              ...
              , i = e.offsets || [0, 0, 0, 0]
              , s = this.horiz
              , o = this.width = Math.round(tv(tx(e.width, t.plotWidth - i[3] + i[1]), t.plotWidth))
              , r = this.height = Math.round(tv(tx(e.height, t.plotHeight - i[0] + i[2]), t.plotHeight))
              , a = this.top = Math.round(tv(tx(e.top, t.plotTop + i[0]), t.plotHeight, t.plotTop))
              , n = this.left = Math.round(tv(tx(e.left, t.plotLeft + i[3]), t.plotWidth, t.plotLeft));
        ...
        unsquish() {
            ...
            if (i) {
                if (!t.staggerLines && (tn(r) ? p = [r] : o < t.autoRotationLimit && (p = t.autoRotation)),
                p) {
                    let t, e;
                    for (let i of p)
                        (i === r || i && i >= -90 && i <= 90) && (e = (t = h(Math.abs(a / Math.sin(e0 * i)))) + Math.abs(i / 360)) < c && (c = e,
                        d = i,
                        l = t)
                }
            } else
            ...
            this.labelRotation = tx(d, tn(r) ? r : 0),
            t.step ? s : l
        }
        getSlotWidth(t) {
            let e = this.chart
        ...
        renderUnsquish() {
            ...
            th(o.rotation) || (l.rotation = o.rotation || 0),
            ...
            i.forEach(function(t) {
                let e = s[t]
                  ...
                  , a = {};
                i && (i.attr(l),
                e.shortenLabel ? e.shortenLabel() : p && !o && "nowrap" !== r.whiteSpace && (p < (i.textPxLength || 0) || "DIV" === i.element.tagName) ? i.css(_(a, {
                    width: `${p}px`,
                    lineClamp: g
        ...
        addTitle(t) {
            ...
            a || this.axisTitle.css(tp(r.style)),
        ...
        createGroups() {
            ...
            this.axisGroup || (this.gridGroup = r("grid", "-grid", s.gridZIndex).clip(this.clippable ? e.plotClipInner : void 0),
        ...
        getOffset() {
            let {chart: t, horiz: e, options: i, side: s, ticks: o, tickPositions: r, coll: a} = this, n = this.hasData(), h = i.title, l = i.labels, d = tn(i.crossing), c = t.axisOffset, p = t.clipOffset, g = [-1, 1, 1, -1][s], u = this.tickRotCorr || {
                x: 0,
                y: 0
            }, f = 0, m, x = 0, y, b = 0, v = 0, k, w, M;
            if (this.showAxis = m = n || i.showEmpty,
            this.staggerLines = this.horiz && l.staggerLines || void 0,
            this.createGroups(),
            n || this.isLinked ? (this.shuffleTicks(),
            r.forEach(this.generateTick.bind(this)),
            this.renderUnsquish(),
            f = Math.abs((u = this.tickRotCorr).x),
            M = this.reserveSpaceDefault = 0 === s || 2 === s || ({
                1: "left",
                3: "right"
            })[s] === this.labelAlign,
            (l.reserveSpace ?? (!d && null) ?? ("center" === this.labelAlign || null) ?? M) && r.forEach(function(t) {
                v = Math.max(o[t].getLabelSize(), v)
            }),
            this.staggerLines && (v *= this.staggerLines),
            !e && tn(this.labelRotation) && M && (v -= f),
            this.labelOffset = v * (this.opposite ? -1 : 1)) : tu(o, function(t, e) {
                t.destroy(),
                delete o[e]
            }),
            h?.text && !1 !== h.enabled && (this.addTitle(m),
            m && !d && !1 !== h.reserveSpace && (this.titleOffset = x = this.axisTitle.getBBox()[e ? "height" : "width"],
            b = j(y = h.offset) ? 0 : tx(h.margin, e ? 5 : 10))),
            this.renderLine(),
            this.offset = g * (tn(i.offset) ? i.offset : c[s] ? c[s] + (i.margin || 0) : 0),
            w = 0 === s ? -this.labelMetrics().h : 2 === s ? u.y : 0,
            k = Math.abs(v) + b,
            v && (k -= w,
            k += g * (e ? l.y ?? u.y + g * l.distance : l.x ?? (M ? g * (l.distance - f) : u.x + g * l.distance)),
            !e && !M && "center" === this.labelAlign && tn(this.labelRotation) && (k += f)),
        ...
        getTitlePosition(t) {
            ...
            return q(this, "afterGetTitlePosition", {
                titlePosition: f
            }),
            f
        }
        ...
        renderTick(t, e, i) {
            let s = this.isLinked
              , o = this.ticks;
            (!s || t >= this.min && t <= this.max || this.grid?.isColumn) && (o[t] || (o[t] = new eU(this,t)),
        ...
        render() {
            ...
            if (i.hasData() || n) {
                ...
                m && (0 === i.min || i.single) && (d[-1] || (d[-1] = new eU(i,-1,null,!0)),
                d[-1].render(-1))),
                u && h.forEach(function(r, a) {
                    e = void 0 !== h[a + 1] ? h[a + 1] + m : i.max - m,
                    a % 2 == 0 && r < i.max && e <= i.max + (s.polar ? -m : m) && (p[r] || (p[r] = new E.PlotLineOrBand(i,{})),
                    t = r + m,
                    p[r].options = {
        ...
        drawCrosshair(t, e) {
            ...
            t || (t = this.cross?.e),
            a && !1 !== (j(e) || !n)) {
                if (clearTimeout(this.crossShowTimer),
                n ? j(e) && (s = tx("colorAxis" !== this.coll ? e.crosshairPos : null, this.isXAxis ? e.plotX : this.len - e.plotY)) : s = t && (this.horiz ? t.chartX - this.pos : this.len - t.chartY + this.pos),
                j(s) && (r = {
                ...
                this.crossShowTimer = tS( () => {
                    let e = this.cross;
                    e || (this.cross = e = h.renderer.path().addClass("highcharts-crosshair highcharts-crosshair-" + (o ? "category " : "thin ") + (a.className || "")).attr({
                        zIndex: tx(a.zIndex, 2)
                    }).clip(!1 === a.clip ? void 0 : h.plotClipInner).add(),
                    !h.styledMode && (e.attr({
    ...
    e2.keepProps = ["coll", "extKey", "hcEvents", "len", "names", "series", "userMax", "userMin"],
    !function(t) {
        function e() {
        ...
        class s {
            ...
            normalizeTimeTickInterval(t, e) {
                let i = e || [["millisecond", [1, 2, 5, 10, 20, 25, 50, 100, 200, 500]], ["second", [1, 2, 5, 10, 15, 30]], ["minute", [1, 2, 5, 10, 15, 30]], ["hour", [1, 2, 3, 4, 6, 8, 12]], ["day", [1, 2]], ["week", [1, 2]], ["month", [1, 2, 3, 4, 6]], ["year", null]], s = i[i.length - 1], o = tE[s[0]], r = s[1], a, n;
        ...
        class s {
            ...
            getLogTickPositions(t, e, i, s) {
                ...
                t >= .5)
                    ...
                    t = tg(t = tx("auto" === d ? null : d, this.minorAutoInterval, (l - h) * c / (p || 1))),
    ...
    class e9 {
        ...
        render() {
            q(this, "render");
            let {axis: t, options: e} = this, {chart: i, horiz: s, logarithmic: o} = t, {color: r, events: a, zIndex: n=0} = e, {renderer: h, time: l} = t.chart, d = {}, c = l.parse(e.to), p = l.parse(e.from), g = l.parse(e.value), u = e.borderWidth, f = e.label, {label: m, svgElem: x} = this, y = [], b, v = j(p) && j(c), k = j(g), w = !x, M = {
                class: "highcharts-plot-" + (v ? "band " : "line ") + (e.className || "")
            }, C = v ? "bands" : "lines";
            if (!i.styledMode && (k ? (M.stroke = r || "var(--highcharts-neutral-color-40)",
            M["stroke-width"] = tx(e.width, 1),
            e.dashStyle && (M.dashstyle = e.dashStyle)) : v && (M.fill = r || "var(--highcharts-highlight-color-10)",
            u && (M.stroke = e.borderColor,
            M["stroke-width"] = u))),
            d.zIndex = n,
            C += "-" + n,
            (b = t.plotLinesAndBandsGroups[C]) || (t.plotLinesAndBandsGroups[C] = b = h.g("plot-" + C).clip(i.plotClipOuter).attr(d).add()),
            x || (this.svgElem = x = h.path().attr(M).add(b)),
            j(g))
                y = t.getPlotLinePath({
                    value: o?.log2lin(g) ?? g,
            ...
            f && (j(f.text) || j(f.formatter)) && y?.length && t.width > 0 && t.height > 0 && !y.isFlat ? (f = tp({
            ...
            this.renderLabel(f, y, v, n)) : m && m.hide(),
            this
        }
        renderLabel(t, e, i, s) {
            let o = this.axis
            ...
            (!n.alignValue || "left" === n.alignValue || j(a)) && n.css({
                width: (t.style?.width || (i && a ? p : 90 === n.rotation ? o.height - (n.alignAttr.y - o.top) : (t.clip ? o.width + o.left : o.chart.chartWidth) - n.alignAttr.x)) + "px"
            }),
            n.show(!0)
        }
        getLabelText(t) {
    ...
    let {animObject: e4} = tq
      , {format: e8} = ee
      , {composed: e7, dateFormats: it, doc: ie, isSafari: ii} = E
      , {distribute: is} = ei
      , io = t => {
    ...
    class ir {
        ...
        getClassName(t, e, i) {
            let s = this.options
              , o = t.series
              , r = o.options;
            return [s.className, "highcharts-label", i && "highcharts-tooltip-header", e ? "highcharts-tooltip-box" : "highcharts-tooltip", !i && "highcharts-color-" + tx(t.colorIndex, o.colorIndex), r?.className].filter(th).join(" ")
        }
        getLabel({anchorX: t, anchorY: e}={
            ...
            if (!this.label) {
                if (this.outside) {
                    ...
                    a.className = "highcharts-container highcharts-tooltip-container " + (t.renderTo.className.match(/(highcharts[a-zA-Z0-9-]+)\s?/gm) || ""),
            ...
            return a && !a.parentElement && E.doc.body.appendChild(a),
            this.label
        }
        getPlayingField() {
            let {body: t, documentElement: e} = ie
        ...
        getPosition(t, e, i) {
            ...
            let M = !this.followPointer && tx(i.ttBelow, !d && !n === w)
              ...
              , A = () => {
                !1 !== C.apply(0, b) ? !1 !== S.apply(0, v) || k || (T(!0),
                A()) : k ? g.x = g.y = 0 : (T(!0),
                A())
            }
            ;
        ...
        hide(t) {
            let e = this;
            io(this),
            t = tx(t, this.options.hideDelay),
            this.isHidden || (this.hideTimer = tS(function() {
                let i = e.getLabel();
                e.getLabel().animate({
                    opacity: 0
                }, {
        ...
        init(t, e) {
            ...
            this.outside = tx(e.outside, !!(t.scrollablePixelsX || t.scrollablePixelsY))
        }
        ...
        move(t, e, i, s) {
            let {followPointer: o, options: r} = this
              , a = e4(!o && !this.isHidden && !r.fixed && r.animation)
              , n = o || (this.len || 0) > 1
              , h = {
                x: t,
                y: e
        ...
        refresh(t, e) {
            ...
            if (!o.enabled || !h.series)
                return;
            io(this),
            i.allowShared = !(!tl(t) && t.series && t.series.noSharedTooltip),
            p = p && !i.allowShared,
            i.followPointer = !i.split && h.series.tooltipOptions.followPointer;
            let g = i.getAnchor(t, e)
              , u = g[0]
              , f = g[1];
            a && i.allowShared && (r.applyInactiveState(n),
            ...
            h.points = void 0;
            let x = h.series;
            this.distance = tx(x.tooltipOptions.distance, 16),
            !1 === m ? this.hide() : this.showTimer = tS( () => {
                if (i.split && i.allowShared)
                    i.renderSplit(m, n);
                else {
                    let t = u
                      , a = f;
                    if (e && r.isDirectTouch && (t = e.chartX - s.plotLeft,
                    a = e.chartY - s.plotTop),
                    !(s.polar || !1 === x.options.clip || n.some(e => r.isDirectTouch || e.series.shouldShowTooltip(t, a))))
                        return void i.hide();
                    {
                        let t = i.getLabel(p && i.tt || {});
                        (!o.style.width || c) && t.css({
                            width: (this.outside ? this.getPlayingField() : s.spacingBox).width - 2 * o.padding + "px"
                        }),
                        t.attr({
                        ...
                        this.outside && t.attr({
                            x: H(t.x || 0, 0, this.getPlayingField().width - (t.width || 0) - 1)
                        }),
                        c || t.attr({
                            stroke: o.borderColor || h.color || x.color || "var(--highcharts-neutral-color-60)"
                        }),
                        i.updatePosition({
                            plotX: u,
                            plotY: f,
                ...
                i.isHidden && i.label && i.label.attr({
                    opacity: 1
                }).show(),
                i.isHidden = !1
            }
        ...
        renderSplit(t, e) {
            let i = this
              ...
              , v = i.outside && "number" != typeof d ? ie.documentElement.getBoundingClientRect() : {
                left: y,
                right: y + o,
                top: b,
                bottom: b + r
              ...
              , {left: C, top: S} = x.getChartPosition()
              , T = m || u
              , A = h + b
              , P = 0
              , L = a - l
              , O = function(t, e, s, o, r=[0, 0], a=!0) {
                let n, h;
                if (s.isHeader)
                    h = M ? 0 : L,
                    n = H(r[0] - t / 2, v.left, v.right - t - (i.outside ? C : 0));
                else if (u && s) {
                    ...
                    h = r[1] - A,
                    n = H(n = a ? r[0] - t - p : r[0] + p, a ? n : v.left, v.right);
                return {
                    x: n,
                    y: h
                }
                    ...
                    let r = e[o - 1] || {
                      ...
                      , f = d.tt = function(t, e, s) {
                        ...
                        if (!o) {
                            ...
                            c || (t.fill = h.backgroundColor,
                            t["stroke-width"] = h.borderWidth ?? +!n.fixed),
                            o = w.label("", 0, 0, h.shape || (u && !r ? "rect" : "callout"), void 0, void 0, n.useHTML).addClass(i.getClassName(e, !0, r)).attr(t).add(k)
                        }
                        return o.isActive = !0,
                        c || o.css(h.style),
                        o.attr({
                        ...
                        c || o.attr({
                            stroke: h.borderColor || e.color || a.color || "var(--highcharts-neutral-color-80)"
                        }),
                        o
                    }(d.tt, r, s.toString())
                      , x = f.getBBox()
                      , y = x.width + f.strokeWidth();
                    l && (P = x.height + g.header.distance,
                    L += P,
                    M && (A -= P));
            ...
            E.forEach(function(t) {
                ...
                !o && (i.outside && C + e < I.left && (I.left = C + e),
                i.outside && I.left + s > I.right && (I.right = C + e))
            }),
            E.forEach(function(t) {
                ...
                if (i.outside && e < s) {
                    let t = C - I.left;
                    t > 0 && (n.x = a ? (I.right - I.left) / 2 : e + t,
                    n.anchorX = s + t)
                }
                t.tt.attr(n)
            });
        ...
        drawTracker() {
            ...
            N(t.tracker.element, "mouseenter", () => io(t)),
        ...
        headerFooterFormatter(t, e) {
            ...
            return q(this, "headerFormatter", a, function(e) {
                if (r && !n && tn(t.key) && (n = r.getXDateFormat(t.key, s.dateTimeLabelFormats)),
                r && n) {
                    if (tc(n)) {
                        let t = n;
                        it[0] = e => i.chart.time.dateFormat(t, e),
                        n = "%0"
                    }
                ...
                e.text = e8(h, t, this.chart)
            }),
            a.text || ""
        }
        update(t) {
            this.destroy(),
            this.init(this.chart, tp(!0, this.options, t))
        }
        updatePosition(t) {
            ...
            if (a && i) {
                ...
                a.setSize(H(h + b, 0, m.documentElement.clientWidth) - 1, n + b, !1),
                (1 !== g || 1 !== u) && (Y(i, {
                    transform: `scale(${g}, ${u})`
                }),
                x *= g,
    ...
    class ic {
        ...
        applyOptions(t, e, i) {
            ...
            return _(this, t = ic.prototype.optionsToObject.call(this, t)),
            this.options ? this.options = s.chart.options.chart.allowMutatingData ? _(this.options, t) : tp(this.options, t) : this.options = t,
            o && (this.y = ic.prototype.getNestedProperty.call(this, o)),
            tn(e) && (this.x = e),
            i || (this.selected && (this.state = "select"),
        ...
        getOrigin({x: t=0, y: e=0}, i={}) {
            ...
            return o.is("column") || this.plotHigh || (r.y = e),
            r
        }
        destroy() {
            if (!this.condemned) {
                let t = this
                  ...
                  , i = e.chart
                  , s = i.hoverPoints
                  , {duration: o} = ih(t.series.chart.renderer.globalAnimation)
                  , r = () => {
                    for (let e in (t.graphic || t.graphics || t.dataLabel || t.dataLabels) && (tw(t),
                    t.destroyElements()),
                    t)
                        delete t[e]
                }
                ...
                s && (t.setState(),
                Z(s, t),
                s.length || (i.hoverPoints = void 0)),
                t === i.hoverPoint && t.onMouseOut(),
                o && e.condemnedPoints ? (e.condemnedPoints.push(this),
        ...
        destroyElements(t={
            ...
            let e, i, s = this, o = [];
            for (t.graphic && o.push("graphic", "connector"),
        ...
        getNestedProperty(t) {
            if (t)
                return 0 === t.indexOf("custom.") ? te(t, this.options) : this[t]
        }
        getZone() {
        ...
        optionsToObject(t) {
            ...
            if (tn(t) || null === t)
                ...
                for (!i && t.length > o && ("string" == (a = typeof t[0]) ? e.xAxis?.dateTime ? r.x = e.chart.time.parse(t[0]) : r[e.tupleKey || "name"] = t[0] : "number" === a && (r.x = t[0]),
                n++); h < o; )
                    i && void 0 === t[n] || (r[s[h]] = t[n]),
                    n++,
                    h++;
            else
                "object" == typeof t && (r = t,
            ...
            return (i || !e.options.data) && Object.keys(r).forEach(t => {
                t.indexOf(".") > 0 && (ic.prototype.setNestedProperty(r, r[t], t),
                delete r[t])
            }
            ),
            r
        ...
        update(t, e=!0, i, s) {
            ...
            function d() {
                ...
                let s = a && o.hasMockGraphic
                  , d = o.index
                  , c = null === o.y ? !s : s;
                a && c && (o.graphic = a.destroy(),
                delete o.hasMockGraphic),
                tc(t, !0) && (a?.element && t?.marker && void 0 !== t.marker.symbol && (o.graphic = a.destroy()),
                t?.dataLabels && o.dataLabel && (o.dataLabel = o.dataLabel.destroy()));
                let p = o.optionsToObject(t);
                !r.hasProcessedDataTable && (r.dataTable.setRow(p, d),
                l && (l[d] = tc(l[d], !0) || tc(t, !0) ? o.options : t ?? l[d])),
                r.isDirty = r.isDirtyData = !0,
                "x"in p && (th(p.x) && (r.xColumnIsNumbers = void 0),
                o.x = r.getX(p.x),
        ...
        manageEvent(t) {
            let e = tp(this.series.options.point, this.options)
              , i = e.events?.[t];
            td(i) && (!this.hcEvents?.[t] || this.hcEvents?.[t]?.map(t => t.fn).indexOf(i) === -1) ? (this.importedUserEvent?.(),
            this.importedUserEvent = N(this, t, i),
            this.hcEvents && (this.hcEvents[t].userEvent = !0)) : this.importedUserEvent && !i && this.hcEvents?.[t] && this.hcEvents?.[t].userEvent && (tw(this, t),
        ...
        setState(t, e) {
            ...
            this.graphic && !this.hasMockGraphic) {
                ...
                !d.styledMode) {
                    ...
                    f = tx(d.options.chart.animation, o.animation);
                    let e = u.opacity;
                ...
                g && this.graphic.animate(g, tx(d.options.chart.animation, n.animation, r.animation)),
                m && m.hide()
            } else
                ...
                g && (m ? m[e ? "animate" : "attr"]({
                    x: g.x,
                    y: g.y
                }) : x && (i.stateMarkerGraphic = m = d.renderer.symbol(x, g.x, g.y, g.width, g.height, tp(r, n)).add(i.markerGroup),
                m.currentSymbol = x)),
            ...
            p.point = this,
            d.styledMode || p.attr(_({
                fill: this.color || i.color,
                "fill-opacity": y.opacity
            }, t5.filterUserAttributes(y.attributes || {})))) : p?.point?.haloPath && !p.point.destroyed && p.animate({
    ...
    let ip = ic
      , {charts: ig, composed: iu, isTouchDevice: im} = E
      , ix = (t, e) => !j(e) || t[`${e}Key`];
    class iy {
        ...
        destroy() {
            ...
            this.eventsToUnbind = [],
            !E.chartCount && (iy.unbindDocumentMouseUp.forEach(t => t.unbind()),
            iy.unbindDocumentMouseUp.length = 0,
            iy.unbindDocumentTouchEnd && (iy.unbindDocumentTouchEnd = iy.unbindDocumentTouchEnd())),
            tu(t, function(e, i) {
                t[i] = void 0
            })
        }
        ...
        drag(t) {
            ...
            this.hasDragged > 10)) {
                ...
                this.hasZoom && f && !p && !m && (this.selectionMarker = m = e.renderer[l](),
                m.attr({
        ...
        getSelectionBox(t) {
            ...
            return q(this, "getSelectionBox", e),
            e.result
        }
        drop(t) {
        ...
        findNearestKDPoint(t, e, i) {
            ...
            return t.forEach(function(t) {
                ...
                tc(l, !0) && l.series && (!tc(s, !0) || (r = (o = s).distX - l.distX,
                a = o.dist - l.dist,
        ...
        getChartCoordinatesFromPoint(t, e) {
            ...
            if (i && s) {
                let r = t.clientX ?? t.plotX ?? 0
                  , a = t.plotY || 0;
                return t.isNode && o && tn(o.x) && tn(o.y) && (r = o.x,
                a = o.y),
                e ? {
        ...
        getHoverData(t, e, i, s, o, r) {
            ...
            c && (o && !h.noSharedTooltip ? (l = i.filter(function(t) {
                ...
                let e = t.options?.nullInteraction
                  , i = ts(t.points, function(t) {
                    return t.x === c.x && (!t.isNull || !!e)
                });
                tc(i) && (t.boosted && t.boost && (i = t.boost.getPoint(i)),
                a.push(i))
            }) : a.push(c)),
            q(this, "afterGetHoverData", d = {
                hoverPoint: c
            }),
            {
        ...
        normalize(t, e) {
            let i = t.touches
              , s = i ? i.length ? i.item(0) : tx(i.changedTouches, t.changedTouches)[0] : t;
        ...
        onContainerClick(t) {
            let e = this.chart
              ...
              , o = e.plotLeft
              , r = e.plotTop;
            !e.cancelClick && (i && this.inClass(s.target, "highcharts-tracker") ? (q(i.series, "click", _(s, {
                point: i
            })),
            e.hoverPoint && i.firePointEvent("click", s)) : (_(s, this.getCoordinates(s)),
        ...
        onDocumentMouseUp(t) {
            ...
            ig[tx(iy.hoverChartIndex, -1)]?.pointer?.drop(t)
        }
        pinch(t) {
            let e = this
            ...
            e.res = !0,
            i.mouseDownX = t.chartX) : h ? this.runPointActions(e.normalize(t)) : o && (q(i, "touchpan", {
                originalEvent: t,
                touches: r
            }, () => {
                let e = t => {
        ...
        runPointActions(t, e, i) {
            ...
            this.unDocMouseMove || (this.unDocMouseMove = N(s.container.ownerDocument, "mousemove", t => ig[iy.hoverChartIndex ?? -1]?.pointer?.onDocumentMouseMove(t)),
            this.eventsToUnbind.push(this.unDocMouseMove)),
            s.axes.forEach(function(e) {
                let i, o = e.crosshair?.snap ?? !0;
                o && ((i = s.hoverPoint) && i.series[e.coll] === e || (i = ts(c, t => t.series?.[e.coll] === e))),
        ...
        setDOMEvents() {
            ...
            this.eventsToUnbind.push(N(t, "mouseenter", this.onContainerMouseEnter.bind(this)), N(t, "mouseleave", this.onContainerMouseLeave.bind(this))),
            iy.unbindDocumentMouseUp.some(t => t.doc === e) || iy.unbindDocumentMouseUp.push({
                doc: e,
                unbind: N(e, "mouseup", this.onDocumentMouseUp.bind(this))
            });
            let s = i(this.chart.renderTo);
            for (; s && "BODY" !== s.tagName; )
                this.eventsToUnbind.push(N(s, "scroll", () => {
                    delete this.chartPosition
                }
                )),
                s = i(s);
            ...
            iy.unbindDocumentTouchEnd || (iy.unbindDocumentTouchEnd = N(e, "touchend", this.onDocumentTouchEnd.bind(this), {
                passive: !1
            })),
            this.setPointerCapture(),
            N(this.chart, "redraw", this.setPointerCapture.bind(this))
        }
        setPointerCapture() {
            if (!im)
                return;
            let t = this.pointerCaptureEventsToUnbind
              , e = this.chart
              , i = e.container
              , s = (e.options.tooltip?.followTouchMove ?? !0) && e.series.some(t => t.options.findNearestPointBy.indexOf("y") > -1);
        ...
        setHoverChartIndex(t) {
            let e = this.chart
              , i = E.charts[tx(iy.hoverChartIndex, -1)];
            if (i && i !== e) {
                let s = {
        ...
        touch(t, e) {
            ...
            1 === (t = this.normalize(t)).touches.length ? ((s = o.isInsidePlot(t.chartX - o.plotLeft, t.chartY - o.plotTop, {
                visiblePlotOnly: !0
            })) && !o.exporting?.openMenu ? (e && this.runPointActions(t),
            "touchmove" === t.type && (this.hasPinchMoved = i = !!r[0] && Math.pow(r[0].chartX - t.chartX, 2) + Math.pow(r[0].chartY - t.chartY, 2) >= 16),
            tx(i, !0) && this.pinch(t)) : e && this.reset(),
            (o.tooltip?.options.followTouchMove ?? !0) && s && t.preventDefault()) : 2 === t.touches.length && this.pinch(t)
        }
        touchSelect(t) {
        ...
        zoomOption(t) {
            ...
            /touch/.test(t.type) && (s = tx(e.zooming.pinchType, s)),
            this.zoomX = o = /x/.test(s),
            this.zoomY = r = /y/.test(s),
            this.zoomHor = o && !i || r && i,
            this.zoomVert = r && !i || o && i,
            this.hasZoom = (o || r) && ix(t, e.zooming.key)
        }
    }
    iy.unbindDocumentMouseUp = [],
    (h = iy || (iy = {})).compose = function(t) {
    ...
    let ib = iy
      ...
      , iw = class {
        ...
        getRowObject(t, e) {
            let i = {}
              , s = this.columns;
            for (let o of (e ?? (e = Object.keys(this.columns)),
            e))
                i[o] = s[o]?.[t];
            return i
        }
        ...
        setColumns(t, e, i) {
            ...
            i?.silent || (q(this, "afterSetColumns"),
            this.versionTag = tI())
        }
        setRow(t, e=this.rowCount, i, s) {
            ...
            tu(r, (s, o) => {
                s && (i ? s = ik(s, e, 0, !0, [t[o]]).array : s[e] = o in t ? t[o] : s[e],
                r[o] = s)
            }
            ),
            this.applyRowCount(Math.max(a, this.rowCount)),
            s?.silent || (q(this, "afterSetRows", {
                rowIndex: e
            }),
            this.versionTag = tI())
        }
    ...
    function iC(t, e, i) {
        ...
        if (m && !1 !== m.enabled && n) {
            ...
            t = 0),
            s.symbol = f = c.symbol(l, n / 2 - t, g - t, 2 * t, 2 * t, _({
                context: "legend"
    ...
    iM.lineMarker = iC;
    let iS = v
      , {defaultOptions: iT} = tX;
    var iA = k || (k = {});
    function iP(t, e) {
        let i = iT.plotOptions || {}
          , s = e.defaultOptions
          , o = e.prototype;
        return o.type = t,
        o.pointClass || (o.pointClass = ip),
        !iA.seriesTypes[t] && (s && (i[t] = s),
        iA.seriesTypes[t] = e,
        !0)
    }
    iA.seriesTypes = E.seriesTypes,
    iA.registerSeriesType = iP,
    iA.seriesType = function(t, e, i, s, o) {
        let r = iT.plotOptions || {};
        if (e = e || "",
        r[t] = tp(r[e], i),
        delete iA.seriesTypes[t],
        iP(t, K(iA.seriesTypes[e] || E.Series, s)),
        iA.seriesTypes[t].prototype.type = t,
        o) {
            class e extends ip {
            }
            _(e.prototype, o),
            iA.seriesTypes[t].prototype.pointClass = e
        }
        return iA.seriesTypes[t]
    }
    ;
    let iL = k
      , {animObject: iO, setAnimation: iE} = tq
      , {defaultOptions: iI} = tX
      , {registerEventOptions: iD} = e$
      , {svg: iB, win: iN} = E
      , {seriesTypes: iz} = iL
      , {format: iR} = ee;
    class iW {
        ...
        init(t, e) {
            ...
            let o = this.options
              , r = !1 !== o.visible;
            this.dataTable ?? (this.dataTable = o.dataTable?.isDataTable ? o.dataTable : new iw(o.dataTable)),
            this.linkedSeries = [],
            this.bindAxes(),
            _(this, {
                name: o.name,
            ...
            q(this, "bindAxes", null, function() {
                (e.axisTypes || []).forEach(function(o) {
                    (s[o] || []).forEach(function(s) {
                        t = s.options,
                        (tx(i[o], 0) === s.index || void 0 !== i[o] && i[o] === t.id) && (tO(e, s.series),
                        e[o] = s,
                        s.isDirty = !0)
                    }),
        ...
        autoIncrement(t) {
            ...
            if (this.pointInterval = e = tx(this.pointInterval, i.pointInterval, 1),
            o && tn(t) && (e *= t),
            s) {
                let t = r.toParts(a);
            ...
            return o && tn(t) ? a + e : (this.xIncrement = a + e,
            a)
        }
        setOptions(t) {
            ...
            let h = n.plotOptions[this.type]
              , l = o.plotOptions || {}
              , d = l.series || {}
              , c = iI.plotOptions[this.type] || {}
              , p = l[this.type] || {};
            h.dataLabels = this.mergeArrays(c.dataLabels, h.dataLabels),
            this.userOptions = n.userOptions;
            let g = tp(h, s.series, p, r)
              , {negativeColor: u, negativeFillColor: f, zoneAxis: m="y", zones: x} = g
              , y = (x || []).map(t => ({
                ...t
            }));
            return this.tooltipOptions = tp(iI.tooltip, iI.plotOptions.series?.tooltip, c?.tooltip, i.userOptions.tooltip, l.series?.tooltip, p.tooltip, r.tooltip),
            this.stickyTracking = tx(r.stickyTracking, p.stickyTracking, d.stickyTracking, !!this.tooltipOptions.shared && !this.noSharedTooltip || g.stickyTracking),
            ...
            a || ("boolean" != typeof u && (e.color = u),
            e.fillColor = f),
            y.push(e)),
            y.length && j(y[y.length - 1].value) && y.push(a ? {} : {
                color: this.color,
        ...
        getCyclic(t, e, i) {
            ...
            !e && (j(o = tx("color" === t ? this.options.colorIndex : void 0, this[a])) ? s = o : (r.series.length || (r[n] = 0),
            s = r[n] % h,
            r[n] += 1),
            i && (e = i[s])),
            void 0 !== s && (this[a] = s),
        ...
        getColumn(t, e, i) {
            ...
            if ("x" === t && !r) {
                ...
                !a || this.xAxis?.hasNames || e.relativeXValue || a.length < (e.turboThreshold || 1 / 0) && !this.boosted && !i(a)) {
                    let e = [];
                    for (let i = 0; i < o; i++) {
                        let s = a?.[i];
                        j(s) || (this.xIncrement ?? (this.xIncrement = e[e.length - 1] ?? null)),
        ...
        getX(t, e) {
            return this.xAxis?.hasNames && this.dataTable.getColumn("name", !0) && j(e) ? this.xAxis.nameToX({
                name: e,
                series: this
            }, t) : void 0 === t || tn(t) && this.options.relativeXValue ? this.autoIncrement(t) : ("string" == typeof t && tn(t = this.chart.time.parse(t)),
            t)
        }
        matchPoints(t, e, i, s) {
            ...
            for (g = 0; g < o.rowCount; g++) {
                let r = x?.[g]
                  ...
                  , m = b?.[g]
                  , k = v?.[g]
                  , [w,M] = u && e ? [u, e] : m && i ? [m, i] : j(k) && s ? [k, s] : j(r) && t ? [r, t] : []
                  , C = -1;
                if (M) {
            ...
            if (p) {
                ...
                g = h.length; g--; )
                    (u = h[g]) && !u.touched && (u.destroy(),
                    h.splice(g, 1));
                this.isDirtyData = this.isDirty = !0
            } else if (c && !n?.enabled) {
                for (g = 0; g < o.rowCount; g++)
                    if (!h[g].destroyed && !h[g].condemned) {
            ...
            return null === this.xIncrement && k.length && (this.xIncrement = R(k),
            this.autoIncrement()),
            !0
        }
        getDataColumnKeys() {
        ...
        setData(t, e=!0, i, s) {
            ...
            if (f.options.chart.allowMutatingData || (h.data && delete this.options.data,
            ...
            this.colorCounter = 0,
            tl(t) ? this.setDataFromArray(t) : this.setDataFromTable(t),
            !1 === s || !d || this.cropped || this.hasGroupedData || !this.visible || this.boosted || (o = this.matchPoints(c, p, g, u)),
            !o) {
                for (th(this.getColumn("y")[0]) && tL(14, !0, f),
                this.data = [],
                r = d; r--; )
                    l[r]?.destroy();
            ...
            tl(t) && (this.options.data = this.userOptions.data = t),
        ...
        setDataFromArray(t) {
            ...
            if (l) {
                ...
                if (tn(s) && tn(p))
                    ...
                    if (a) {
                        let e = s.length === a
                          , i = Array(s.length).fill(0).map( () => []);
                        for (let e of t)
                            for (let t = 0; t <= a; t++)
                                i[t]?.push(e[t]);
                        n.setColumns((e ? r : h).reduce( (t, e, s) => (t[e] = i[s],
                        t), {}))
                    } else {
                        i && (d = i.indexOf("x"),
                        c = i.indexOf("y"),
            ...
            r.forEach( (t, e) => {
                let i = h.reduce( (i, s) => {
                    let o = n?.[s]
                      , r = t.columns || {}
                      , a = t.id
                      , h = th(o) ? 0 === e && r[o] : ((o?.dataTable || 0) === e || a && o?.dataTable === a) && (tn(o?.column) ? Object.values(r)[o.column] : r[o?.column || s]);
                    return h && (i[s] = h),
                    i
                }
                , {});
        ...
        bindDataTableEvents(t, e) {
            ...
            s.push(N(t, "afterSetRows", t => {
                let i = t.rowIndex;
                if (tn(i)) {
                    let t = iw.prototype.getRowObject.call({
                        columns: e
                    }, i)
                      , s = this.data[i];
                    t && (this.currentDataGrouping ? this.setData() : (s ? s.update(t, !1) : this.addPoint(t, !1),
                    o()))
                }
            }
            )),
        ...
        getProcessedData(t) {
            ...
            s && e.sorted && !n && (!a || l > a || e.forceCrop) && (m[l - 1] < u || m[0] > f ? x = new iw : e.getColumn(e.pointValKey || "y").length && (m[0] < u || m[l - 1] > f) && (x = (d = this.cropData(i, u, f)).modified,
            p = d.start,
            c = !0))),
            m = this.getColumn("x", !0),
            {
                modified: x,
                cropped: c,
                cropStart: p,
        ...
        cropData(t, e, i) {
            ...
            let l = Object.keys(t.columns).reduce( (e, i) => (e[i] = (t.getColumn(i, !0) || []).slice(n, h),
            e), {});
        ...
        generatePoints() {
            ...
            f = 0; f < r; f++)
                g = a + f,
                n ? ((u = new o(this,i.getRowObject(f, c))).dataGroup = this.groupMap?.[d + f],
                u.dataGroup?.options && (u.options = u.dataGroup.options,
                _(u, u.dataGroup.options),
                delete u.dataLabels,
                u.key = u.name ?? u.category)) : (u = m[g],
                x = e ? e[g] : i.getRowObject(f),
                u || void 0 === x ? u && (u.category = this.xAxis?.categories?.[u.x] ?? u.x,
                u.key = u.name ?? u.category) : m[g] = u = new o(this,x,s[f])),
                u && (u.index = n ? d + f : g,
                l[f] = u);
        ...
        getExtremes(t, e) {
            ...
            return q(this, "afterGetExtremes", {
                dataExtremes: b
            }),
            b
        }
        ...
        translate() {
            ...
            for (g = 0; g < h; g++) {
                ...
                t.plotX = u = b(h),
                s && this.visible && C && C[h] && (m = this.getStackIndicator(m, h, this.index),
                !t.isNull && m.key && (k = (p = C[h]).points[m.key]),
                p && tl(k) && (M = k[0],
                w = k[1],
                M === c && m.key === C[h].base && (M = tx(tn(o) ? o : i.min)),
                i.positiveValuesOnly && j(M) && M <= 0 && (M = void 0),
                t.total = t.stackTotal = tx(p.total),
                t.percentage = j(t.y) && p.total ? t.y / p.total * 100 : void 0,
                t.stackY = w,
                this.irregularWidths || p.setOffset(this.pointXOffset || 0, this.barW || 0, void 0, void 0, void 0, this.xAxis))),
                t.yBottom = j(M) ? y(i.translate(M, !1, !0, !1, !0)) : void 0,
                this.dataModify && (w = this.dataModify.modifyValue(w, g)),
                t.plotY = v(w, t),
                t.origin = !r || t.graphic || a ? void 0 : {
                    x: b(h, !0),
                    y: v(w, t, !0)
                },
                t.isInside = this.isPointInside(t),
                t.clientX = d ? G(e.translate(h, !1, !1, !1, !0, l)) : u,
                t.negative = (t.y || 0) < (o || 0),
                !t.isNull && !1 !== t.visible && tn(u) && (tn(f) && (x = Math.min(x, Math.abs(u - f))),
                f = u),
        ...
        getValidPoints(t, e, i) {
            ...
            return (t || this.points || []).filter(function(t) {
                ...
                return (!!i || !t.isNull && !!tn(r)) && (!e || !!s.isInsidePlot(o, r, {
                    inverted: s.inverted
                })) && !1 !== t.visible
            })
        }
        ...
        afterAnimate() {
            this.setClip(),
            tu(this.chart.sharedClips, (t, e, i) => {
        ...
        drawPoints(t) {
            ...
            let h = this.chart
              ...
              , f = this.xAxis
              , m = tx(p.enabled, !f || !!f.isRadial || null, this.closestPointRangePx >= p.enabledThreshold * p.radius);
        ...
        markerAttribs(t, e) {
            ...
            e && (n = s?.states?.[e],
            h = o.states?.[e],
            l = tx(h?.radius, n?.radius, l && l + (n?.radiusPlus || 0))),
            t.hasImage = r && 0 === r.indexOf("url"),
            t.hasImage && (l = 0);
            let d = t.pos();
            return tn(l) && d && (i.crisp && (d[0] = F(d[0], t.hasImage ? 0 : "rect" === r ? s?.lineWidth || 0 : 1)),
            a.x = d[0] - l,
            a.y = d[1] - l),
        ...
        pointAttribs(t, e) {
            ...
            e = e || "normal",
            l = s.states[e] || {},
            u = tx((d = r.states && r.states[e] || {}).lineWidth, l.lineWidth, u + tx(d.lineWidthPlus, l.lineWidthPlus, 0)),
            p = d.fillColor || l.fillColor || p,
            g = d.lineColor || l.lineColor || g,
            f = tx(d.opacity, l.opacity, f),
            {
                stroke: g,
                "stroke-width": u,
                fill: p,
        ...
        applyZones() {
            let {area: t, chart: e, graph: i, zones: s, points: o, xAxis: r, yAxis: a, zoneAxis: n} = this
              ...
              , f = (t, e=0, i=0) => {
                ...
                let {translated: s=0, lineClip: o, value: r} = t
                  , a = i - s;
                o?.push(["L", e, Math.abs(a) < u ? i - u * (a < 0 || 0 === a && j(r) ? -1 : 1) : s])
            }
            ;
            if (s.length && (i || t) && d && tn(d.min)) {
                ...
                if (s.forEach(t => {
                    t.lineClip = [],
                    t.translated = H(d.toPixels(tx(t.value, e), !0) || 0, 0, p)
                }
                ),
        ...
        plotGroup(t, e, i, s, o) {
            ...
            return j(this.opacity) && !this.chart.styledMode && "inactive" !== this.state && (n.opacity = this.opacity),
            r || (this[t] = r = this.chart.renderer.g().add(o)),
            r.addClass("highcharts-" + e + " highcharts-series-" + this.index + " highcharts-" + this.type + "-series " + (j(this.colorIndex) ? "highcharts-color-" + this.colorIndex + " " : "") + (this.options.className || "") + (r.hasClass("highcharts-tracker") ? " highcharts-tracker" : ""), !0),
        ...
        searchKDTree(t, e, i, s, o) {
            ...
            this.kdTree)
                return function t(e, i, s, o) {
                    ...
                    b.distX = j(u) ? Math.abs(u) - y : Number.MAX_VALUE;
                    let M = (e[v] || 0) - (b[v] || 0) + (d && b.marker?.radius || 0)
                      , C = M < 0 ? "left" : "right"
                      , S = M < 0 ? "right" : "left";
                    return i[C] && ([k,w] = c(b, t(e, i[C], s + 1, o), h)),
                    i[S] && p(Math.sqrt(M * M), k[h], w) && (k = c(k, t(e, i[S], s + 1, o), h)[0]),
                    k
                }(t, this.kdTree, l, l)
        }
        pointPlacementToXValue() {
            ...
            tn(i) ? i * (t.pointRange || e.pointRange) : 0
        }
        isPointInside(t) {
        ...
        drawTracker() {
            let t = this
              ...
              , l = "rgba(192,192,192," + (iB ? 1e-4 : .002) + ")"
              , d = t.tracker;
            d ? d.attr({
                d: s
        ...
        addPoint(t, e, i, s, o) {
            ...
            e = tx(e, !0);
            let {applyOptions: f, optionsToObject: m} = this.pointClass.prototype
              , x = {
                series: this
            }
              , y = m.call(x, t);
            ...
            p && x.name && (p[b] = x.name),
            g?.splice(a, 0, t),
            (r || this.hasProcessedDataTable) && (this.data.splice(a, 0, null),
            this.processData()),
            "point" === n.legendType && this.generatePoints(),
            i && (l[0] && l[0].remove ? l[0].remove(!1) : ([l, g, this.xColumn].filter(j).forEach(t => {
                t.shift()
            }
            ),
            d.deleteRows(0))),
        ...
        removePoint(t, e, i) {
            let s = this
              ...
              , h = r[t]
              , l = function() {
                [a?.length === r.length ? a : void 0, r, s.options.data, s.xColumn].filter(j).forEach(e => {
                    e.splice(t, 1)
                }
                ),
                n.deleteRows(t),
        ...
        update(t, e) {
            q(this, "update", {
                options: t = U(t, this.userOptions)
            });
            let i = this, s = i.chart, o = i.userOptions, r = i.initialType || i.type, a = s.options.plotOptions, n = iz[r].prototype, h = i.finishedAnimating && {
                animation: !1
            }, l = {}, d = t.data || t.dataTable, c, p, g = iW.keepProps.slice(), u = t.type || o.type || s.options.chart.type, f = !(this.hasDerivedData || u && u !== this.type || void 0 !== t.keys || void 0 !== t.pointStart || void 0 !== t.pointInterval || void 0 !== t.relativeXValue || t.joinBy || t.mapData || ["dataGrouping", "pointStart", "pointInterval", "pointIntervalUnit", "keys"].some(t => i.hasOptionChanged(t)));
            u = u || r,
            f ? (g.push.apply(g, iW.keepPropsForPoints),
            !1 !== t.visible && (g.push("area", "graph"),
            "zones"in t || g.push("zones")),
            i.parallelArrays.forEach(function(t) {
                g.push(t + "Data")
            }),
            d && (t.dataSorting && _(i.options.dataSorting, t.dataSorting),
            this.setData(d, !1))) : this.dataTable.modified = this.dataTable,
            ...
            (g = ["dataLabelsGroup", "dataLabelsGroups", "dataLabelsParentGroups", "group", "markerGroup", "plotClipGroup", "transformGroup"].concat(g)).forEach(function(t) {
                g[t] = i[t],
                delete i[t]
            });
            let m = !1;
            if (iz[u]) {
                ...
                m)
                    ...
                    Object.setPrototypeOf)
                        Object.setPrototypeOf(i, iz[u].prototype);
                    else {
            ...
            i.init(s, t),
            f && this.points)
                for (let t of (!1 === (c = i.options).visible ? (l.graphic = 1,
                l.dataLabel = 1) : (this.hasMarkerChanged(c, o) && (l.graphic = 1),
        ...
        setState(t, e) {
            let i = this
              ...
              , n = tx(a?.[t || "normal"]?.animation, i.chart.options.chart.animation)
        ...
        drawLegendSymbol(t, e) {
            let i = this.chart.renderer
              ...
              , c = (t.baseline || 0) - a + 1
              , p = r.symbolRadius ?? a
              , g = "rectangle" === s ? i.rect(d, c, l, a, p) : i.symbols[s] && i.symbol(s, d, c, l, a, {
                r: p
            });
            g ? o.symbol = g.addClass("highcharts-point").attr({
                zIndex: 3
            }).add(o.group) : iS[s]?.call(this, t, e)
        }
    }
    iW.defaultOptions = {
        lineWidth: 2,
    ...
    iW.types = iL.seriesTypes,
    iW.registerType = iL.registerSeriesType,
    iW.keepProps = ["colorIndex", "eventOptions", "navigatorSeries", "symbolIndex", "baseSeries"],
    iW.keepPropsForPoints = ["data", "isDirtyData", "isDirtyCanvas", "points", "condemnedPoints", "dataTable", "hasProcessedDataTable", "xIncrement", "cropped", "_hasPointMarkers", "hasDataLabels", "nodes", "layout", "level", "mapMap", "mapData", "minY", "maxY", "minX", "maxX", "transformGroups"],
    _(iW.prototype, {
    ...
    iL.series = iW;
    let iH = iW
      , {animObject: iG, setAnimation: iX} = tq
      , {registerEventOptions: iF} = e$
      , {composed: iY, marginNames: ij} = E
      , {distribute: i$} = ei
      , {format: iV} = ee;
    class iU {
        constructor(t, e) {
        ...
        update(t, e) {
            let i = this.chart;
            this.setOptions(tp(!0, this.options, t)),
            "events"in this.options && iF(this, this.options),
            this.destroy(),
        ...
        colorizeItem(t, e) {
            ...
            if ((t instanceof iH || t instanceof ip) && (t.color = t.options?.legendSymbolColor || i),
            o?.[e ? "removeClass" : "addClass"]("highcharts-legend-item-hidden"),
            !this.chart.styledMode) {
                let {itemHiddenStyle: i={}} = this
                  , o = i.color
                  , {fillColor: h, lineColor: l} = t.options
                  , d = t => (!e && (t.fill && (t.fill = o),
                t.stroke && (t.stroke = o)),
                t);
                r?.css(tp(e ? this.itemStyle : i)),
                a?.attr(d({
                    stroke: l || t.color
                })),
                n?.attr(d(t.series ? t.series.pointAttribs?.(t) : t.pointAttribs?.() || {
                    fill: t.color
                })),
                s?.attr(d({
                    fill: h || t.color,
        ...
        setText(t) {
            ...
            t.legendItem.label.attr({
                text: e.labelFormat ? iV(e.labelFormat, t, this.chart) : e.labelFormatter.call(t, t)
            })
        }
        renderItem(t) {
            ...
            i.styledMode || y.css(tp(t.visible ? h : l)),
            y.attr({
                align: c ? "left" : "right",
                zIndex: 2
            }).add(e.group),
            ...
            this.symbolHeight = tx(o.symbolHeight, this.fontMetrics.f),
            o.squareSymbol && (this.symbolWidth = tx(o.symbolWidth, Math.max(this.symbolHeight, 16)),
            ...
            (i.styledMode || !h.width) && y.css({
                width: Math.min(o.itemWidth || this.widthOption || i.spacingBox.width, o.maxWidth ? tv(o.maxWidth, i.chartWidth) : 1 / 0) - b + "px"
            }),
            this.setText(t);
            let v = y.getBBox()
        ...
        adjustMargins(t, e) {
            ...
            o && [/(lth|ct|rth)/, /(rtv|rm|rbv)/, /(rbh|cb|lbh)/, /(lbv|lm|ltv)/].forEach( (r, a) => {
                r.test(o) && !j(t[a]) && (i[ij[a]] = Math.max(i[ij[a]], i.legend[(a + 1) % 2 ? "legendHeight" : "legendWidth"] + [1, -1, -1, 1][a] * s[a % 2 ? "x" : "y"] + (s.margin ?? 12) + e[a] + (i.titleOffset[a] || 0)))
            }
            )
        }
        proximatePositions() {
            ...
            for (let o of (this.allItems.forEach(function(t) {
                ...
                t.points && (o = ts(a ? t.points : t.points.slice(0).reverse(), function(t) {
                    return tn(t.plotY)
                })),
            ...
            i$(i, e.plotHeight)))
                t = o.item.legendItem || {},
                tn(o.pos) && (t.y = e.plotTop - e.spacing[0] + o.pos)
        }
        render() {
            ...
            this.offsetWidth = 0,
            this.lastItemY = 0,
            this.widthOption = tv(s.width, e - o),
            d = e - 2 * o - s.x,
            ...
            this.renderTitle(),
            tC(r, (t, e) => (t.options?.legendIndex || 0) - (e.options?.legendIndex || 0)),
            ...
            n = (s.maxWidth ? Math.min(this.widthOption || this.offsetWidth, d, tv(s.maxWidth, t.chartWidth) || 1 / 0) : this.widthOption || this.offsetWidth) + o,
        ...
        handleOverflow(t) {
            ...
            this.currentPage = tx(this.currentPage, 1),
            this.fullHeight = t,
            g.forEach( (t, e) => {
        ...
        setItemEvents(t, e, i) {
            ...
            for (let i of d)
                i && i.on("mouseover", function() {
                    ...
                    s.chart.styledMode || e.css(tp(t.visible ? s.itemStyle : s.itemHiddenStyle)),
                    c(""),
                    r.removeClass(h),
                    t.setState()
                }).on("click", function(e) {
    ...
    ;
    let iZ = iU
      , {animate: i_, animObject: iK, setAnimation: iq} = tq
      , {defaultOptions: iJ} = tX
      , {numberFormat: iQ} = ee
      , {registerEventOptions: i0} = e$
      , {charts: i1, doc: i2, marginNames: i5, win: i3} = E
      , {seriesTypes: i6} = iL;
    class i9 {
        static chart(t, e, i) {
            let s = new i9(t,e,i);
        ...
        constructor(t, e, i) {
            if (this.sharedClips = {},
            !i2)
                return void tL(36, !1, this);
            const s = [...arguments];
            (th(t) || t.nodeName) && (this.renderTo = s.shift()),
            this.init(s[0], s[1])
        }
        setZoomOptions() {
        ...
        init(t, e) {
            q(this, "init", {
                ...
                this.userOptions = _({}, t),
                (this.renderTo = th(o) ? i2.getElementById(o) : o) || tL(13, !0, this),
                this.margin = [],
                this.spacing = [],
                this.labelCollectors = [],
                !0 === e ? this.promise = new Promise(t => {
                    this.callback = t
                }
                ) : this.callback = e,
                this.isResizing = 0,
                ...
                this.time = new tR(_(i.time || {}, {
                    locale: this.locale
                }),i.lang),
                i.time = this.time.options,
                this.numberFormatter = (s.numberFormatter || iQ).bind(this),
                this.styledMode = s.styledMode,
                this.hasCartesianSeries = s.showAxes,
                this.index = i1.length,
        ...
        orderItems(t, e=0) {
            let i = this[t]
              , s = this.options[t] = tM(this.options[t]).slice()
              , o = this.userOptions[t] = this.userOptions[t] ? tM(this.userOptions[t]).slice() : [];
            ...
            i)
                for (let t = e, r = i.length; t < r; ++t) {
                    let e = i[t];
                    e && (e.index = t,
                    e instanceof iH && (e.name = e.getName()),
        ...
        getClipBox(t, e) {
            let i = this.inverted
              , {xAxis: s, yAxis: o} = t || {}
              , {x: r, y: a, width: n, height: h} = tp(this.clipBox);
            return t && (s && s.len !== this.plotSizeX && !s.isRadial && (n = s.len),
        ...
        isInsidePlot(t, e, i={}) {
            ...
            return q(this, "afterIsInsidePlot", u),
            u.isInsidePlot
        }
        redraw(t) {
            q(this, "beforeRedraw");
            ...
            e.forEach(function(t) {
                ...
                h.push(function() {
                    q(t, "afterSetExtremes", _(t.eventArgs, t.getExtremes())),
                    delete t.eventArgs
                })),
                (p || d) && t.redraw()
            }),
        ...
        createAxes() {
            ...
            for (let e of (q(this, "createAxes"),
            ["xAxis", "yAxis"]))
                for (let i of t[e] = tM(t[e] || {}))
                    new e2(this,i,e);
        ...
        applyDescription(t, e) {
            let i = this
              , s = this.options[t] = tp(this.options[t], e)
              , o = this[t];
            ...
            ,
            this.styledMode || o.css(_("title" === t ? {
        ...
        layOutTitles(t=!0) {
            ...
            ["title", "subtitle", "caption"].forEach(t => {
                ...
                if (i && r) {
                    ...
                    m.align ?? (m.align = "title" === t ? u < p ? "left" : "center" : this.title?.alignValue),
        ...
        getChartSize() {
            ...
            this.chartHeight = Math.max(0, tv(i, this.chartWidth) || (o ? 400 : s.height)),
            this.containerBox = s
        }
        temporaryDisplay(t) {
            ...
            if (t)
                for (; e?.style; )
                    e.hcOrigStyle && (Y(e, e.hcOrigStyle),
                    delete e.hcOrigStyle),
                    e.hcOrigDetached && (i2.body.removeChild(e),
                    e.hcOrigDetached = !1),
                    e = e.parentNode;
            else
                for (; e?.style && (i2.body.contains(e) || e.parentNode || (e.hcOrigDetached = !0,
                i2.body.appendChild(e)),
                ("none" === ti(e, "display", !1) || e.hcOrigDetached) && (e.hcOrigStyle = {
        ...
        getContainer() {
            ...
            tn(a) && i1[a] && i1[a].hasRendered && i1[a].destroy(),
            W(r, s, this.index),
            ...
            this.styledMode || Y(l, {
                width: tx(i.style?.width, h + "px")
            })),
            this._cursor = l.style.cursor,
            this.renderer = new eH(l,h,n,void 0,i.forExport,e.exporting?.allowHTML,this.styledMode,e.palette,this.index),
        ...
        getMargins(t) {
            ...
            this.resetMargins(),
            s[0] && !j(i[0]) && (this.plotTop = Math.max(this.plotTop, s[0] + e[0])),
            s[2] && !j(i[2]) && (this.marginBottom = Math.max(this.marginBottom, s[2] + e[2])),
        ...
        reflow(t) {
            ...
            !e.exporting?.isPrinting && !e.isResizing && i && s.width && ((s.width !== i.width || s.height !== i.height) && (to(e.reflowTimeout),
            e.reflowTimeout = tS(function() {
                if (e.container) {
        ...
        setChartSize(t) {
            ...
            if (this.plotLeft = e = Math.round(this.plotLeft),
        ...
        drawChartBox() {
            ...
            v || (t.chartBackground = v = y.rect().addClass("highcharts-background").add(),
            T = "attr"),
            b ? M = C = v.strokeWidth() : (C = (M = e.borderWidth || 0) + 8 * !!a,
            S = {
                fill: i || "none"
            },
            (M || v["stroke-width"]) && (S.stroke = e.borderColor,
            S["stroke-width"] = M),
            v.attr(S).shadow(a)),
            v[T]({
                x: C / 2,
            ...
            o && (p ? (o !== p.attr("href") && p.attr("href", o),
            p.animate(g)) : t.plotBGImage = y.image(o, u, f, m, x).add())),
            c ? c.animate({
                width: l.width,
                height: l.height
            ...
            T = "animate",
            w || (T = "attr",
            t.plotBorder = w = y.rect().addClass("highcharts-plot-border").attr({
                zIndex: 1.5
            }).add()),
            w.attr(b ? void 0 : {
        ...
        propFromSeries() {
            ...
            ["inverted", "angular", "polar"].forEach(function(a) {
                ...
                t = r?.length; !i && t--; )
                    (e = i6[r[t].type]) && e.prototype[a] && (i = !0);
                s[a] = i
            })
        }
        linkSeries(t) {
            ...
            i.forEach(function(t) {
                let {linkedTo: s} = t.options
                  , o = th(s) && (":previous" === s ? i[t.index - 1] : e.get(s));
        ...
        render() {
            ...
            , a = 0, n = !0, h, l = 0;
            for (let e of (o && (this.plotClipOuter || (this.plotClipOuter = i.clipRect()),
            ...
            t)) {
                ...
                if (this.hasCartesianSeries && e.horiz && e.visible && i.enabled && e.series.length && "colorAxis" !== e.coll && !e.isRadial) {
                    ...
                    let o = new eU(e,0,"",!0)
                      , r = o.createLabel("x", i);
                    if (o.destroy(),
                    r && tx(i.reserveSpace, !tn(t.crossing)) && (a = r.getBBox().height + i.distance + Math.max(tn(s) ? s : 0, 0)),
                    a) {
                        r?.destroy();
                        break
                    }
        ...
        addCredits(t) {
            ...
            i.events?.click && N(e, "creditsClick", i.events.click),
        ...
        destroy() {
            ...
            for (q(e, "destroy"),
            e.renderer.forExport ? Z(i1, e) : i1[e.index] = void 0,
            E.chartCount--,
        ...
        createAxis(t, e) {
            ...
            return tx(e.redraw, !0) && this.redraw(e.animation),
            i
        }
        showLoading(t) {
            let e = this
              ...
              , a = e.loadingDiv
              , n = e.loadingSpan;
            a || (e.loadingDiv = a = X("div", {
                className: "highcharts-loading highcharts-loading-hidden"
            }, null, e.container)),
            n || (e.loadingSpan = n = X("span", {
                className: "highcharts-loading-inner"
            }, null, a),
            N(e, "redraw", r)),
            a.className = "highcharts-loading",
            t5.setElementHTML(n, tx(t, i.lang.loading, "")),
            !e.styledMode && (Y(a, _(o, {
                zIndex: 10
            })),
            Y(n, s?.labelStyle ?? {}),
            e.loadingShown || (Y(a, {
        ...
        update(t, e, i, s) {
            ...
            tu(t, function(e, i) {
                n[i] && "function" == typeof n[i].update ? n[i].update(e, !1) : "function" == typeof n[h[i]] ? n[h[i]](e) : "colors" !== i && -1 === n.collectionsWithUpdate.indexOf(i) && tp(!0, n.options[i], t[i]),
            ...
            this.collectionsWithUpdate.forEach(e => {
                t[e] && (tM(t[e]).forEach( (t, s) => {
                    ...
                    let r = j(t.id);
                    r && (o = n.get(t.id)),
                    !o && n[e] && (o = n[e][tx(t.index, s)]) && (r && j(o.options.id) || o.options.isInternal) && (o = void 0),
            ...
            let p = c?.width
              , g = c && (th(c.height) ? tv(c.height, p || n.chartWidth) : c.height);
            a || tn(p) && p !== n.chartWidth || tn(g) && g !== n.chartHeight ? n.setSize(p, g, s) : tx(e, !0) && n.redraw(s),
            q(n, "afterUpdate", {
                options: t,
                redraw: e,
                animation: s
        ...
        transform(t) {
            ...
            for (let t of e) {
                let {horiz: e, len: u, minPointOffset: f=0, options: m, reversed: x} = t
                  , y = e ? "width" : "height"
                  , b = e ? "x" : "y"
                  , v = tx(a[y], t.len)
                  , k = tx(s[y], t.len)
                  ...
                  , M = (s[b] || 0) + k / 2 - t.pos
                  , C = M - ((a[b] ?? t.pos) + v / 2 - t.pos) / w
                  , S = x && !l || !x && l ? -1 : 1;
                if (!o && (M < 0 || M > t.len))
                    continue;
                let T = t.chart.polar || t.isOrdinal && w <= 1 ? 0 : f * S || 0
                  , A = t.toValue(C, !0)
                  , P = t.toValue(C + u / w, !0)
                  , L = A + T
                  , O = P - T
                ...
                1 === w && !o && "yAxis" === t.coll && !E) {
                    for (let e of t.series) {
                        ...
                        tn(t.dataMin) && tn(t.dataMax) && (E.dataMin = Math.min(t.dataMin, E.dataMin),
                        E.dataMax = Math.max(t.dataMax, E.dataMax))
                    }
                    t.allExtremes = E
                }
                let {dataMin: I, dataMax: D, min: B, max: N} = _(t.getExtremes(), E || {})
                  , z = d.parse(m.min)
                  , R = d.parse(m.max)
                  , W = I ?? z
                  , H = D ?? R
                  , G = O - L
                  , X = t.categories ? 0 : Math.min(G, H - W)
                  , F = W - X * (j(z) ? 0 : m.minPadding)
                  , Y = H + X * (j(R) ? 0 : m.maxPadding)
                  , $ = t.allowZoomOutside || 1 === w || "zoom" !== n && w > 1
                  , V = Math.min(z ?? F, F, $ ? B : F)
                  , U = Math.max(R ?? Y, Y, $ ? N : Y);
                (!t.isOrdinal || 1 !== w || o) && (L < V && (L = V,
                w >= 1 && (O = L + G)),
                O > U && (O = U,
                w >= 1 && (L = O - G)),
                (o || t.series.length && (L !== B || O !== N) && L >= V && O <= U) && (r ? r[t.coll].push({
                    axis: t,
                    min: L,
                    max: O
                }) : (t.isPanning = "zoom" !== n,
            ...
            ) : (!p || g || this.resetZoomButton ? !p && this.resetZoomButton && (this.resetZoomButton = this.resetZoomButton.destroy()) : this.showResetZoom(),
    ...
    _(i9.prototype, {
        ...
        propsRequireDirtyBox: ["backgroundColor", "borderColor", "borderWidth", "borderRadius", "plotBackgroundColor", "plotBackgroundImage", "plotBorderColor", "plotBorderRadius", "plotBorderWidth", "plotShadow", "shadow"],
    ...
    let {stop: i4} = tq
      , {composed: i8} = E;
    function i7() {
        (this.scrollablePixelsX || this.scrollablePixelsY) && !this.scrollablePlotArea && (this.scrollablePlotArea = new se(this)),
    ...
    class se {
        static compose(t, e, i) {
            tb(i8, "ScrollablePlotArea") && (N(t, "afterInit", st),
        ...
        constructor(t) {
            ...
            this.chart = t;
            const a = this.parentDiv = X("div", {
                className: "highcharts-scrolling-parent"
            }, {
                position: "relative"
            }, t.renderTo)
              , n = this.scrollingContainer = X("div", {
                className: "highcharts-scrolling"
            }, r, a)
              , h = this.innerContainer = X("div", {
                className: "highcharts-inner-container"
            }, void 0, n)
              , l = this.fixedDiv = X("div", {
              ...
              , d = this.fixedRenderer = new eH(l,t.chartWidth,t.chartHeight,i.style);
            ...
            N(t, "afterShowResetZoom", o),
            N(t, "afterApplyDrilldown", o),
            N(t, "afterLayOutTitles", o),
            N(n, "scroll", () => {
        ...
        applyFixed() {
            ...
            let y = d - o[0] - 1
              ...
              , M = d + h - g
              , C = [["M", 0, 0]];
            p ? C = [["M", 0, y], ["L", l - 1, y], ["L", l - 1, v], ["L", 0, v], ["Z"], ["M", w, y], ["L", r, y], ["L", r, v], ["L", w, v], ["Z"]] : g && (C = [["M", b, 0], ["L", b, d - 1], ["L", k, d - 1], ["L", k, 0], ["Z"], ["M", b, M], ["L", b, a], ["L", k, a], ["L", k, M], ["Z"]]),
    ...
    let {format: si} = ee
      ...
      , so = class {
        ...
        render(t) {
            let e = this.axis.chart
              , i = this.options
              , s = i.format
              , o = (s ? si(s, this, e) : i.formatter?.call(this, this)) || "";
            if (this.label)
                this.label.attr({
                    text: o,
                    visibility: "hidden"
        ...
        setOffset(t, e, i, s, o, r) {
            ...
            if (h && p) {
                ...
                i && ss.prototype.justifyDataLabel.call(n, h, a, h.alignAttr, t, p),
                h.attr({
                    x: h.alignAttr.x,
                    y: h.alignAttr.y,
                    rotation: l.rotation,
                ...
                tx(!i && l.crop, !0) && (s = tn(h.x) && tn(h.y) && c.isInsidePlot(h.x - e + (h.width || 0), h.y) && c.isInsidePlot(h.x + e, h.y)),
                h[s ? "show" : "hide"]()
            }
        ...
        getStackBox(t) {
            let e = this.axis
              ...
              , h = e.stacking.usePercentage ? 100 : tx(s, this.total, 0)
              , l = e.toPixels(h)
              , d = t.xAxis || i.xAxis[0]
              , c = tx(o, d.translate(this.x)) + r
              , p = Math.abs(l - e.toPixels(n || tn(e.min) && e.logarithmic && e.logarithmic.lin2log(e.min) || 0))
              , g = i.inverted
              , u = this.isNegative;
            return g ? {
      ...
      , {getDeferredAnimation: sr} = tq
      , {series: {prototype: sa}} = iL;
    function sn() {
        let t = this.inverted;
        this.axes.forEach(t => {
        ...
        this.series.forEach(e => {
            ...
            e.options.stacking && e.reserveSpace() && (e.stackKey = [e.type, tx(e.options.stack, ""), t ? i.top : i.left, t ? i.height : i.width].join(","))
        }
        )
    }
    function sh() {
    ...
    function su(t, e) {
        ...
        h = 0; h < g; h++) {
            ...
            w[a][e].total = null) : w[a][e] = new so(t,t.options.stackLabels,!!s,e,x)),
            o = w[a][e],
            null !== g ? (o.points[n] = o.points[this.index] = [tx(o.cumulative, m)],
            j(o.cumulative) || (o.base = n),
            ...
            let C = o.total || 0;
            "percent" === l ? (r = s ? y : b,
            C = v && w[r]?.[e] ? (r = w[r][e]).total = Math.max(r.total || 0, C) + Math.abs(u) : G(C + Math.abs(u))) : "group" === l ? tn(g) && C++ : C = G(C + u),
            "group" === l ? o.cumulative = (C || 1) - 1 : o.cumulative = G(tx(o.cumulative, m) + u),
            o.total = C,
    ...
    class sf {
        ...
        resetStacks() {
            tu(this.stacks, t => {
                tu(t, (e, i) => {
                    tn(e.touched) && e.touched < this.stacksTouched ? (e.destroy(),
        ...
        renderStackTotals() {
            let t = this.axis
              ...
              , i = e.renderer
              , s = this.stacks
              , o = sr(e, t.options.stackLabels?.animation || !1)
    ...
    (w || (w = {})).compose = function(t, e, i) {
        let s = e.prototype
          , o = i.prototype;
        s.getStacks || (N(t, "init", sl),
        N(t, "destroy", sh),
        s.getStacks = sn,
        o.getStackIndicator = sd,
        o.modifyStacks = sc,
        o.percentStacker = sp,
        o.setGroupedPoints = sg,
        o.setStackedPoints = su)
    }
    ;
    let sm = w;
    class sx extends iH {
        drawGraph() {
            ...
            [this, ...this.zones].forEach( (s, o) => {
                ...
                if (a ? (a.endX = this.preventGraphAnimation ? null : e.xMap,
                a.animate({
                    d: e
                ...
                t.shadow)) {
                    let e = this.chart.inverted
                      ...
                      , s = tc(t.shadow) ? tp(e ? {} : i, t.shadow) : !!e || i;
                    a.shadow(s)
                }
                a && (a.startX = e.xMap,
                a.isArea = e.isArea)
        ...
        getGraphPath(t, e, i) {
            ...
            (t = this.getValidPoints(t, !1, o.nullInteraction || !(o.connectNulls && !e && !i))).forEach(function(l, d) {
                ...
                f && !j(e) && d > 0 ? n = !o.connectNulls : f && !e ? n = !0 : (0 === d || n ? c = [["M", l.plotX, l.plotY]] : s.getPointSpline ? c = [s.getPointSpline(t, l, d)] : h ? (c = 1 === h ? [["L", u.plotX, g]] : 2 === h ? [["L", (u.plotX + p) / 2, u.plotY], ["L", (u.plotX + p) / 2, g]] : [["L", p, u.plotY]]).push(["L", p, g]) : c = [["L", p, g]],
                a.push(l.x),
                h && (a.push(l.x),
                2 === h && a.push(l.x)),
                r.push.apply(r, c),
    ...
    sx.defaultOptions = tp(iH.defaultOptions, {
        legendSymbol: "lineMarker"
    }),
    iL.registerSeriesType("line", sx);
    ...
    class sb extends sy {
        ...
        getGraphPath(t) {
            let e, i, s, o = sy.prototype.getGraphPath, r = this.options, a = r.stacking, n = this.yAxis, h = [], l = [], d = this.index, c = n.stacking.stacks[this.stackKey], p = r.threshold, g = Math.round(n.getThreshold(r.threshold)), u = tx(r.connectNulls, "percent" === a), f = function(i, s, o) {
                ...
                f && (x || m) ? (y = (m ? f[0] : f[1]) + x,
                b = f[0] + x,
                v = !!m) : !a && u && (u.isNull || !j(u.plotY)) && (y = b = p),
                void 0 !== y && (l.push({
                    plotX: e,
            ...
            for (let o = 0, r = t.length; o < r; ++o)
                ...
                i = t[o].isNull || !j(t[o].plotY),
                e = tx(t[o].rectPlotX, t[o].plotX),
                s = a ? tx(t[o].yBottom, g) : g,
                (!i || u) && (u || f(o, o - 1, "left"),
                i && !a && u || (l.push(t[o]),
                h.push({
                    x: o,
                    ...
                    if (n[t] && !n[t].isNull)
                        ...
                        [-1, 1].forEach(function(i) {
                            ...
                            if (r) {
                                ...
                                for (; i >= 0 && i < l; ) {
                                    let s = h[i].index;
                                    !(m = r.points[s]) && (s === e.index ? n[t][o] = !0 : g[i] && (x = a[t].points[s]) && (p -= x[1] - x[0])),
                                    i += d
                                }
                            }
    ...
    class sk extends sv {
        getPointSpline(t, e, i) {
            ...
            let p = ["C", tx(l.rightContX, l.plotX, 0), tx(l.rightContY, l.plotY, 0), tx(s, n, 0), tx(o, h, 0), n, h];
            return l.rightContX = l.rightContY = void 0,
            p
        }
    }
    sk.defaultOptions = tp(sv.defaultOptions),
    iL.registerSeriesType("spline", sk);
    let sw = sk
      , {area: sM, area: {prototype: sC}} = iL.seriesTypes;
    class sS extends sw {
    }
    sS.defaultOptions = tp(sw.defaultOptions, sM.defaultOptions),
    _(sS.prototype, {
    ...
    class sL extends iH {
        animate(t) {
            ...
            t && h ? (d.scaleY = .001,
            i = H(o.toPixels(n.threshold || 0), r, r + o.len),
            l ? d.translateX = (i += a ? -Math.floor(h[+!!l]) : Math.ceil(h[l ? 3 : 2])) - o.len : d.translateY = i += a ? Math.ceil(h[+!!l]) : -Math.floor(h[l ? 3 : 2]),
            s.clipBox && s.setClip(),
            s.group.attr(d)) : (e = Number(s.group.attr(c)),
            s.group.animate({
                scaleY: 1
            }, _(sT(s.options.animation), {
                step: function(t, i) {
        ...
        getColumnMetrics() {
            ...
            let l = Math.min(Math.abs(i.transA) * (!i.brokenAxis?.hasBreaks && i.ordinal?.slope || e.pointRange || i.closestPointRange || i.tickInterval || 1), i.len)
              , d = l * e.groupPadding
              , c = (l - 2 * d) / (h || 1)
              , p = Math.min(e.maxPointWidth || i.len, tx(e.pointWidth, c * (1 - 2 * e.pointPadding)))
              , g = (t.columnIndex || 0) + +!!r;
        ...
        crispCol(t, e, i, s) {
            ...
            return s = F(e + s, o, r) - (e = F(e, o, r)),
            this.options.crisp && (i = F(t + i, o) - (t = F(t, o))),
            {
                x: t,
                y: e,
                width: i,
        ...
        translate() {
            ...
            iH.prototype.translate.apply(t),
            t.points.concat(t.condemnedPoints).forEach(function(s) {
                ...
                tn(n) && tn(g) && s.y === n && g <= n && (a.min || 0) < n && (p !== g || (a.max || 0) <= n) && (b = !b,
                s.negative = !s.negative),
                v = Math.abs(v - u) > h ? o - (b ? h : 0) : u - (b ? h : 0)),
                j(s.options.pointWidth) && (M -= Math.round(((w = C = Math.ceil(s.options.pointWidth)) - d) / 2)),
                i.centerInCategory && (M = t.adjustForMissingColumns(M, w, s, l)),
                s.barX = M,
                s.pointWidth = w,
                s.tooltipPos = e.inverted ? [H(a.len + a.pos - e.plotLeft - y, a.pos - e.plotLeft, a.len + a.pos - e.plotLeft), r.len + r.pos - e.plotTop - M - C / 2, k] : [r.left - e.plotLeft + M + C / 2, H(y + a.pos - e.plotTop, a.pos - e.plotTop, a.len + a.pos - e.plotTop), k],
                s.shapeType = t.pointClass.prototype.shapeType || "roundedRect",
                s.shapeArgs = t.crispCol(M, v, C, s.isNull ? 0 : k)
            }),
        ...
        pointAttribs(t, e) {
            ...
            c = n.dashStyle || c,
            p = n.borderWidth || p)),
            e && t && (h = (a = tp(i.states[e], t.options.states?.[e] || {})).brightness,
            l = a.color || void 0 !== h && sA(l).brighten(a.brightness).get() || l,
            d = a[o] || d,
            p = a[r] || p,
            c = a.dashStyle || c,
            g = tx(a.opacity, g));
        ...
        drawPoints(t) {
            ...
            t.forEach(function(t) {
                ...
                if (tn(l) && (null !== t.y || r)) {
                    ...
                    !d) {
                        let o = e;
                        t.origin && s.pointCount < h && (o = tp(e, t.getOrigin(t.origin, e)),
                        a || (o.opacity = 0),
                        c = !0,
                        p = "animate"),
                    ...
                    c && d[p](tp(e)),
                    a || d[p](i.pointAttribs(t, t.selected && "select")).shadow(!1 !== t.allowShadow && o.shadow),
                    d.addClass(t.getClassName(), !0).attr({
                        visibility: t.visible ? "inherit" : "hidden"
                    })
                } else
                    d && (t.graphic = d.destroy())
            })
        }
        drawTracker(t=this.points) {
            let e, i = this, s = i.chart, o = s.pointer, r = function(t) {
                ...
                o && e && i.options.enableMouseTracking && (s.isInsidePlot(t.chartX - s.plotLeft, t.chartY - s.plotTop, {
                    visiblePlotOnly: !0
                }) || i.allowOutsidePlotInteraction && o?.inClass(t.target, "highcharts-point") || o?.inClass(t.target, "highcharts-data-label")) && (o.isDirectTouch = !0,
                e.onMouseOver(t))
            };
            t.forEach(function(t) {
                e = tl(t.dataLabels) ? t.dataLabels : t.dataLabel ? [t.dataLabel] : [],
    ...
    !function(t) {
        ...
        function i(t, e, i, s, o) {
            let {chart: r} = this
              ...
              , {crop: c=!0, distance: p, overflow: g="justify", rotation: u=0} = i
              , f = J(i.align)
              , m = J(i.verticalAlign)
              , x = t.pos()
              , y = j(l) && j(d) && r.isInsidePlot(l, Math.round(d), {
                inverted: a,
                paneCoordinates: !0,
                series: this
            })
            ...
            if (x) {
                ...
                "plotEdges" === i.alignTo && this.isCartesian && (s[a ? "x" : "y"] = 0,
        ...
        function r(t) {
            ...
            let e = this
              ...
              , l = o.getContrast(th(a) && a || th(r) && r || "var(--highcharts-background-color)")
              , d = []
              , c = h(e)
            ...
            e.hasDataLabels?.() && t.concat(e.condemnedPoints).forEach(t => {
                let r = t.dataLabels || []
                  , a = t.color || e.color;
                tM(n(c, t.dlOptions || t.options?.dataLabels)).forEach( (n, h) => {
                    ...
                    if (c && (b = j(y = tx(n[t.formatPrefix + "Format"], n.format)) ? sI(y, t, i) : (n[t.formatPrefix + "Formatter"] || n.formatter).call(t, n, t),
                    v = n.rotation,
                    !i.styledMode && (m.color = tx(n.color, m.color, th(e.color) ? e.color : void 0, "var(--highcharts-neutral-color-100)"),
                    "contrast" === m.color ? ("none" !== p && (C = p),
                    t.contrastColor = o.getContrast("auto" !== C && "contrast" !== C && th(C) && C || (th(a) ? a : "")),
                    m.color = C && "contrast" !== C || n.inside || 0 > ty(f || 0) || s.stacking ? t.contrastColor : l) : delete t.contrastColor,
                    ...
                    i.styledMode || (k.fill = "auto" === p ? t.color : p,
                    k.stroke = "auto" === g ? t.color : g,
                    k["stroke-width"] = n.borderWidth),
                    tu(k, (t, e) => {
                        void 0 === t && delete k[e]
                    }
                    )),
                    !w || c && j(b) && !!(w.div || w.text?.foreignObject) == !!n.useHTML && (w.rotation && n.rotation || w.rotation === n.rotation) || (w = void 0,
                    M = !0),
                    c && j(b) && "" !== b && (w ? k.text = b : (w = o.label(b, 0, 0, n.shape, void 0, void 0, n.useHTML, void 0, "data-label")).addClass(" highcharts-data-label-color-" + t.colorIndex + " " + (n.className || "") + (n.useHTML ? " highcharts-tracker" : "")),
                    w)) {
                        w.options = n,
                        w.attr(k),
                        i.styledMode ? m.width && w.css({
                            width: m.width,
                            textOverflow: m.textOverflow,
                            whiteSpace: m.whiteSpace
                        }) : w.css(m).shadow(n.shadow),
                        q(w, "beforeAddingDataLabel", {
                            labelOptions: n,
                            point: t
                        });
                        let s = d[h] = d[h] || this.initDataLabels(h, u, n);
                        w.added || w.add(s),
                        e.alignDataLabel(t, w, n, void 0, M),
                        w.isActive = !0,
                        r[h] && r[h] !== w && r[h].destroy(),
                        r[h] = w
                    }
                }
                );
                let h = r.length;
                for (; h--; )
                    r[h]?.isActive ? r[h].isActive = !1 : (r[h]?.destroy(),
                    r.splice(h, 1));
                t.dataLabel = r[0],
                t.dataLabels = r
            }
        ...
        function a(t, e, i, s, o, r) {
            ...
            return (y = (i.x || 0) - l + c + g) < 0 && ("right" === n && m >= 0 ? (e.align = "left",
            e.inside = !0,
            m -= l) : m -= y,
            b = !0),
            (y = (i.x || 0) + s.width - l - c + g) > a.plotWidth && ("left" === n && m <= 0 ? (e.align = "right",
            e.inside = !0,
            m -= l) : m += a.plotWidth - y,
            b = !0),
            (y = (i.y || 0) - d + c + f) < 0 && ("bottom" === h && x >= 0 ? (e.verticalAlign = "top",
            e.inside = !0,
            x -= d) : x -= y,
            v = !0),
            (y = (i.y || 0) + s.height - d - c + f) > a.plotHeight && ("top" === h && x <= 0 ? (e.verticalAlign = "bottom",
            e.inside = !0,
            x -= d) : x += a.plotHeight - y,
            v = !0),
            (b || v) && (e.x = b ? m : m + l,
            e.y = v ? x : x + d,
            t.placed = !r,
    ...
    function sz(t, e, i, s, o) {
        ...
        sN.prototype.alignDataLabel.call(this, t, e, i, s, o),
    ...
    (C || (C = {})).compose = function(t) {
        sD.compose(sN),
        tb(sB, "ColumnDataLabel") && (t.prototype.alignDataLabel = sz)
    }
    ;
    let sR = C;
    class sW extends sO {
    }
    sW.defaultOptions = tp(sO.defaultOptions, {}),
    _(sW.prototype, {
        inverted: !0
    }),
    iL.registerSeriesType("bar", sW);
    ...
    (d = S || (S = {})).getCenter = function() {
        ...
        let g = [tx(r?.[0], "50%"), tx(r?.[1], "50%"), tx(l && l < 0 ? void 0 : t.size, "100%"), tx(d && d < 0 ? void 0 : t.innerSize || 0, "0%")];
        for (c = 0; c < 4; ++c)
            p = g[c],
            h = c < 2 || 2 === c && /%$/.test(p),
            g[c] = tv(p, [s, o, a, g[2]][c]) + (h ? i : 0);
        return g[3] > g[2] && (g[3] = g[2]),
        tn(n) && 2 * n < g[2] && n > 0 && (g[3] = g[2] - 2 * n),
        q(this, "afterGetCenter", {
            positions: g
        }),
        g
    }
    ...
    let {getStartAndEndRadians: sV} = sY
      , {noop: sU} = E;
    class sZ extends iH {
        animate(t) {
            let e = this
        ...
        drawEmpty() {
            ...
            this.graph.attr({
                d: ew.arc(t, e, this.center[2] / 2, 0, {
                    start: i,
                    end: s,
    ...
    !function(t) {
        ...
        function s() {
            ...
            sJ.prototype.drawDataLabels.apply(t),
            e.forEach(t => {
                (t.dataLabels || []).forEach( (e, i) => {
                    let s = n[2] / 2
                      ...
                      , r = tv(o?.distance || 0, s);
                    0 === i && d[t.half].push(t),
                    !j(o?.style?.width) && e.getBBox().width > a && (e.css({
                ...
                e.forEach(i => {
                    (i.dataLabels || []).forEach(l => {
                        let d = l.options || {}
                          ...
                          , C = "inherit";
                        if (x) {
                            if (g && j(m) && x.distance > 0 && (void 0 === m.pos ? C = "hidden" : (f = m.size,
            ...
            (0 === R(c) || this.verifyDataLabelOverflow(c)) && (this.placeDataLabels(),
            this.points.forEach(e => {
                e.dataLabels?.forEach( (s, o) => {
                    ...
                    if (tn(a)) {
                        ...
                        g = s.connector,
                        n && n.distance > 0 ? (h = !g,
                        g || (s.connector = g = i.renderer.path().addClass("highcharts-data-label-connector  highcharts-color-" + e.colorIndex + (e.className ? " " + e.className : "")).add(t.dataLabelsGroups?.[o])),
                        i.styledMode || g.attr({
                            "stroke-width": a,
        ...
        function r(t) {
            ...
            e[0] += (t[3] - t[1]) / 2),
            null !== s[1] ? r = H(r, o, e[2] - Math.max(t[0], t[2])) : (r = H(r, o, e[2] - t[0] - t[2]),
            e[1] += (t[0] - t[2]) / 2),
            r < e[2] ? (e[2] = r,
            e[3] = Math.min(i.thickness ? Math.max(0, r - 2 * i.thickness) : Math.max(0, tv(i.innerSize || 0, r)), r),
            this.translate(e),
    ...
    function s1(t, e) {
        ...
        q(e, "afterHideOverlappingLabel")) : t.attr({
            opacity: i
        })),
        t.isOld = !0),
        s
    }
    let {defaultOptions: s2} = tX
      , {noop: s5} = E
      , s3 = {
        radius: 0,
        scope: "stack",
    ...
    function s4(t, e, i, s, o={}) {
        ...
        let p = c - d
          , g = Math.sin(p / 2)
          , u = Math.max(Math.min(tv(o.borderRadius || 0, l - h), (l - h) / 2, l * g / (1 + g)), 0)
    ...
    function s8() {
        if (this.options.borderRadius && !(this.chart.is3d && this.chart.is3d())) {
            let {options: t, yAxis: e} = this
              ...
              , s = s2.plotOptions?.[this.type]?.borderRadius
              , o = s7(t.borderRadius, tc(s) ? s : {})
            ...
            for (let s of this.points) {
                ...
                if ("roundedRect" === s.shapeType && a) {
                    ...
                    g || (g = "end");
                    let u = Math.min(tv(o.radius, n), n / 2, "all" === g ? c / 2 : 1 / 0) || 0;
                    "end" === g && (p && (d -= u),
                    c += u),
                    _(a, {
                        brBoxHeight: c,
    ...
    function os(t, e) {
        ...
        o ? ((r = U(a, this.options, !0, this.collectionsWithUpdate)).isResponsiveOptions = !0,
    ...
    E.Tooltip = ia,
    E.addEvent = N,
    E.animObject = tq.animObject,
    E.animate = tq.animate,
    E.arrayMax = R,
    E.arrayMin = z,
    E.attr = W,
    E.chart = i9.chart,
    ...
    E.css = Y,
    E.crisp = F,
    E.dateFormat = ee.dateFormat,
    E.defaultOptions = tX.defaultOptions,
    E.defined = j,
    E.destroyObjectProperties = $,
    E.diffObjects = U,
    E.discardElement = V,
    E.distribute = ei.distribute,
    E.erase = Z,
    E.error = tL,
    E.extend = _,
    E.extendClass = K,
    ...
    E.format = ee.format,
    E.getAlignFactor = J,
    E.getClosestDistance = Q,
    E.getDeferredAnimation = tq.getDeferredAnimation,
    E.getMagnitude = tt,
    E.getNestedProperty = te,
    E.getOptions = tX.getOptions,
    E.getStyle = ti,
    E.insertItem = tO,
    E.isArray = tl,
    E.isClass = ta,
    ...
    E.isObject = tc,
    E.isString = th,
    E.internalClearTimeout = to,
    E.merge = tp,
    E.normalizeTickInterval = tg,
    E.numberFormat = ee.numberFormat,
    E.objectEach = tu,
    E.offset = tf,
    E.pad = tm,
    E.pick = tx,
    ...
    E.removeEvent = tw,
    E.replaceNested = tk,
    E.seriesType = iL.seriesType,
    E.setAnimation = tq.setAnimation,
    E.setOptions = tX.setOptions,
    E.splat = tM,
    E.stableSort = tC,
    E.stop = tq.stop,
    E.syncTimeout = tS,
    E.time = tX.defaultTime,
    E.ucfirst = tT,
    E.timers = tZ.timers,
    E.timeUnits = tE,
    E.uniqueKey = tI,
    E.useSerialIds = function(e) {
        return t = tx(e, t)
    }
    ,
    ...
    function(t, e, i) {
        ...
        if (!e.symbolCustomAttribs.includes("borderRadius")) {
            ...
            N(t, "afterColumnTranslate", s8, {
                order: 9
            }),
            N(s, "afterTranslate", ot),
    ...
    }(E.Series, E.SVGElement, E.SVGRenderer),
    sR.compose(E.Series.types.column),
    sD.compose(E.Series),
    e5.compose(E.Axis),
    eF.compose(E.SVGRenderer),
    iZ.compose(E.Chart),
    e3.compose(E.Axis),
    (o = (p = E.Chart).prototype).hideOverlappingLabels || (o.hideOverlappingLabels = function(t) {
            ...
            o.absoluteBox = function(t) {
                if (t && (!t.alignAttr || t.placed)) {
                    let e = t.box ? 0 : t.padding || 0
                      , i = t.dataLabelPosition?.posAttribs || t.alignAttr || {
                        x: t.attr("x"),
                        y: t.attr("y")
                    }
    ...
    N(p, "render", function() {
        ...
        for (let i of t.yAxis || [])
            i.stacking && i.options.stackLabels && !i.options.stackLabels.allowOverlap && tu(i.stacking.stacks, t => {
                tu(t, t => {
        ...
        for (let i of t.series || [])
            if (i.visible && i.hasDataLabels?.()) {
                let s = s => {
                    for (let o of s)
                        o.visible && (o.dataLabels || []).forEach(s => {
                            let r = s.options || {};
                            s.labelrank = tx(r.labelrank, o.labelrank, o.shapeArgs?.height),
                            r.allowOverlap ?? (i.is("pie") && Number(r.distance) > 0) ? (s.oldOpacity = s.opacity,
                            s.newOpacity = 1,
                            s1(s, t)) : e.push(s)
                        }
                        )
    ...
    sQ.compose(E.Series.types.pie),
    e9.compose(E.Chart, E.Axis),
    ib.compose(E.Chart),
    oo.compose(E.Chart),
    se.compose(E.Axis, E.Chart, E.Series),
    sm.compose(E.Axis, E.Chart, E.Series),
    ia.compose(E.Pointer);
    let or = E;
    return O.default
}
)());
