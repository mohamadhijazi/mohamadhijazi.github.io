...
- profile experience called My Profile
...
- Module content should be read from and written to the user’s Drive/OneDrive folders after consent, rather than being kept only in the application database.
- The server should act as an orchestrator and metadata store only when necessary; user data should remain under user-controlled cloud storage.
