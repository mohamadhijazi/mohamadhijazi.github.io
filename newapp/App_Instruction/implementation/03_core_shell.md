...
## Technology Baseline
The shell should be implemented with plain JavaScript and optional Vue components loaded from CDN, with the business logic handled by ASP.NET Core endpoints and client-side Drive/OneDrive access after user consent.
...
- consent banner and folder-access prompt for Google Drive or Microsoft OneDrive
- profile and workspace switching experience
...
- consent state and Drive/OneDrive folder selection handling
...
- The shell can initiate consent-based Drive/OneDrive access and pass the resulting scoped credentials to modules.
